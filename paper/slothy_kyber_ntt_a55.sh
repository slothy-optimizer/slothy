...
time ../slothy-cli Arm_AArch64 Arm_Cortex_A55                     \
       clean/neon/ntt_kyber_123_4567.s               \
         ...
         -o opt/neon/ntt_kyber_123_4567_opt_a55.s    \
...
time ../slothy-cli Arm_AArch64 Arm_Cortex_A55 \
       clean/neon/ntt_kyber_123_4567_scalar_load.s                          \
         ...
         -l layer4567_start                                                             \
         -c sw_pipelining.enabled=true                                                  \
         -o opt/neon/ntt_kyber_123_4567_scalar_load_opt_a55.s               \
...
time ../slothy-cli Arm_AArch64 Arm_Cortex_A55                                            \
       clean/neon/ntt_kyber_123_4567_scalar_store.s                         \
         ...
         -l layer4567_start                                                             \
         -c sw_pipelining.enabled=true                                                  \
         -o opt/neon/ntt_kyber_123_4567_scalar_store_opt_a55.s              \
...
time ../slothy-cli Arm_AArch64 Arm_Cortex_A55                                                    \
     clean/neon/ntt_kyber_123_4567_scalar_load_store.s                              \
       ...
       -l layer4567_start                                                                       \
       -c sw_pipelining.enabled=true                                                            \
       -o opt/neon/ntt_kyber_123_4567_scalar_load_store_opt_a55.s                   \
...
time ../slothy-cli Arm_AArch64 Arm_Cortex_A55                                    \
     clean/neon/ntt_kyber_123_4567_manual_st4.s                     \
       ...
       -l layer4567_start                                                       \
       -c sw_pipelining.enabled=true                                            \
       -o opt/neon/ntt_kyber_123_4567_manual_st4_opt_a55.s          \
