...
poly_basemul_acc_cache_init_rvv_vlen128_loop:
    ...
    addi a1, a1, 32
    add a2, a2, a7
    montmul_x4 v16, v17, v18, v19, v0, v1, v2, v3, v12, v13, v14, v15, t0, t1, v24, v25, v26, v27
    montmul_x4 v20, v21, v22, v23, v4, v5, v6, v7, v8,  v9,  v10, v11, t0, t1, v24, v25, v26, v27
    add t4, a0, a7
    add a5, a0, t3
    vle16.v v24, (t4)
    vle16.v v25, (a5)
    ...
    montmul_x4 v24, v25, v26, v27, v12, v13, v14, v15, v16, v17, v18, v19, t0, t1, v28, v29, v30, v31
    // store b1zeta
    addi t4, a4, 0*0
    add  a5, a4, a7
    vse16.v v24, (t4)
    ...
    vse16.v v26, (t4)
    vse16.v v27, (a5)
    montmul_x4 v0, v1, v2, v3, v4, v5, v6, v7, v24, v25, v26, v27, t0, t1, v28, v29, v30, v31
    addi t4, a0, 0*2
    add  a5, a0, a6
    vle16.v v28, (t4)
    vle16.v v29, (a5)
    ...
    add a0, a0, t5
    add a4, a4, t5
    bltu a1, t2, poly_basemul_acc_cache_init_rvv_vlen128_loop
    restore_regs
    addi sp, sp, 8*15
ret