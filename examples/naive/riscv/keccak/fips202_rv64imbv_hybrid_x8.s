...
.macro ARoundInPlace  \
    ...
    andn \T02_s, \S08_s, \S07_s
    xor \S06_s, \T02_s, \S11_s
    andn \T02_s, \S09_s, \S08_s
    xor \S07_s, \T02_s, \S07_s
    ld   \T04_s, 18*8(sp)
    andn \T02_s, \S10_s, \S09_s
    xor \S08_s, \T02_s, \S08_s
    ld   \T03_s, 0(\T04_s)
    andn \T02_s, \S11_s, \S10_s
    xor \S09_s, \T02_s, \S09_s
    vxor.vx \S00_v, \S00_v, \T03_s
    andn \T02_s, \S12_s, \S16_s
    xor \S10_s, \T02_s, \S15_s
    addi \T04_s, \T04_s, 8
    andn \T02_s, \S13_s, \S12_s
    xor \S11_s, \T02_s, \S16_s
    sd   \T04_s, 18*8(sp)
    andn \T02_s, \S14_s, \S13_s
    xor \S12_s, \T02_s, \S12_s
    andn \T02_s, \S15_s, \S14_s
    xor \S13_s, \T02_s, \S13_s
    andn \T02_s, \S16_s, \S15_s
    xor \S14_s, \T02_s, \S14_s
    andn \T02_s, \S17_s, \S21_s
    xor \S15_s, \T02_s, \S20_s
    andn \T03_s, \S18_s, \S17_s
    xor \S16_s, \T03_s, \S21_s
...
.globl KeccakF1600_StatePermute_RV64V_8x
.align 2
KeccakF1600_StatePermute_RV64V_8x:
    addi sp, sp, -8*21
    SaveRegs
    sd a0, 15*8(sp)
    # set VPU
