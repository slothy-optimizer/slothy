...
.macro ARoundInPlace  \
    ...
    xor \T02_s, \T02_s, \S14_s
    sd \S01_s, 19*8(sp) # for temporary usage
    xor \T02_s, \T02_s, \S19_s
    ...
    slli \T03_s, \S13_s, 25
    ld \S01_s, 19*8(sp) # restore it from stack
    srli \S12_s, \S13_s, 64-25
    ...
    xor \S02_s, \S02_s, \T02_s
    # Iota for vector impl
    or  \T02_s, \S04_s, \T00_s
    ld \T03_s, 18*8(sp)
    xor \S03_s, \S03_s, \T02_s
    ld \T04_s, 0(\T03_s)
    and \T02_s, \T00_s, \T01_s
