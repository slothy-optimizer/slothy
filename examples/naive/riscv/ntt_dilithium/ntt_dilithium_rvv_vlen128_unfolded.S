...
start:
    ...
    vse32.v v30, (a2)
    vse32.v v31, (a3)
    li   a4, _ZETA_EXP_4TO7_P0_L4*4
    addi a2, a0, (64*0)*4
    add  a4, a4, a1
    addi a3, a0, (64*0+4*8)*4
    lw t2, 0*4(a4)
    lw t1, 1*4(a4)
    lw t4, 2*4(a4)
    lw t3, 3*4(a4)
    ...
    vle32.v v0, (t4)
    vle32.v v1, (t5)
    li   t4, _ZETA_EXP_4TO7_P0_L7*4
    vrgather.vv v8, v17, v1
    vrgather.vv v9, v16, v1
    vrgather.vv v10, v19, v1
    vrgather.vv v11, v18, v1
    vrgather.vv v12, v21, v1
    vrgather.vv v13, v20, v1
    vrgather.vv v14, v23, v1
    vrgather.vv v15, v22, v1
    vmerge.vvm  v16, v8, v16, v0
    vmerge.vvm  v17, v17, v9, v0
    vmerge.vvm  v18, v10, v18, v0
    vmerge.vvm  v19, v19, v11, v0
    ...
    vrgather.vv v10, v27, v1
    vrgather.vv v11, v26, v1
    vrgather.vv v12, v29, v1
    vrgather.vv v13, v28, v1
    vrgather.vv v14, v31, v1
    vrgather.vv v15, v30, v1
    vmerge.vvm  v24, v8, v24, v0
    vmerge.vvm  v25, v25, v9, v0
    vmerge.vvm  v26, v10, v26, v0
    vmerge.vvm  v27, v27, v11, v0
    ...
    vadd.vv  v30, v30, v6
    vs8r.v v24, (a3)
    li   a4, _ZETA_EXP_4TO7_P1_L4*4
    addi a2, a0, (64*1)*4
    add  a4, a4, a1
    addi a3, a0, (64*1+4*8)*4
    lw t2, 0*4(a4)
    lw t1, 1*4(a4)
    lw t4, 2*4(a4)
    lw t3, 3*4(a4)
    ...
    vadd.vv  v30, v30, v6
    vs8r.v v24, (a3)
    li   a4, _ZETA_EXP_4TO7_P2_L4*4
    addi a2, a0, (64*2)*4
    add  a4, a4, a1
    addi a3, a0, (64*2+4*8)*4
    lw t2, 0*4(a4)
    lw t1, 1*4(a4)
    lw t4, 2*4(a4)
    lw t3, 3*4(a4)
    ...
    vadd.vv  v30, v30, v6
    vs8r.v v24, (a3)
    li   a4, _ZETA_EXP_4TO7_P3_L4*4
    addi a2, a0, (64*3)*4
    add  a4, a4, a1
    addi a3, a0, (64*3+4*8)*4
    lw t2, 0*4(a4)
    lw t1, 1*4(a4)
    lw t4, 2*4(a4)
    lw t3, 3*4(a4)
