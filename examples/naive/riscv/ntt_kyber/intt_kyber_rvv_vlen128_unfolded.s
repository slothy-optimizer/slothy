...
.macro intt_rvv_level0to5 off, ZETA_EXP_INTT_0TO5_L0
    ...
    vl4re16.v v0, (a5)
     addi a5, a5, 8*4*2
    gs_bfu_vv_ref_x8  v16, v18, v20, v22, v24, v26, v28, v30,  v17, v19, v21, v23, v25, v27, v29, v31,  v0,  v1,  v2,  v3,  v0,  v1,  v2,  v3, t0, t1,  v8,  v9,  v10, v11, v12, v13, v14, v15
    // level 1
    vl4re16.v v0, (a5)
     addi a5, a5, 8*4*2
    gs_bfu_vv_x8  v16, v20, v24, v28, v17, v21, v25, v29,  v18, v22, v26, v30, v19, v23, v27, v31,  v1,  v0,  v3,  v2,  v1,  v0,  v3,  v2,  v1,  v0,  v3,  v2,  v1,  v0,  v3,  v2, t0,  v8,  v9,  v10, v11, v12, v13, v14, v15
    // level 2
    vl2re16.v v0, (a5)
     addi a5, a5, 8*2*2
    gs_bfu_vv_x8  v16, v24, v17, v25, v18, v26, v19, v27,  v20, v28, v21, v29, v22, v30, v23, v31,  v1,  v0,  v1,  v0,  v1,  v0,  v1,  v0,   v1,  v0,  v1,  v0,  v1,  v0,  v1,  v0,  t0,  v8,  v9,  v10, v11, v12, v13, v14, v15
    // shuffle1
    addi t2, a1, _MASK_10325476*2
    li t6, 0x55
    vle16.v v1, (t2)
    ...
    vl2re16.v v4, (a5)
     addi a5, a5, 8*2*2
    gs_bfu_vv_x8  v16, v17, v18, v19, v20, v21, v22, v23,  v24, v25, v26, v27, v28, v29, v30, v31,  v5,  v4,  v5,  v4,  v5,  v4,  v5,  v4,   v5,  v4,  v5,  v4,  v5,  v4,  v5,  v4,  t0,  v8,  v9,  v10, v11, v12, v13, v14, v15
    // shuffle2
    addi t2, a1, _MASK_01014545*2
     addi t3, a1, _MASK_23236767*2
     li t6, 0x33
    ...
    vl2re16.v v4, (a5)
     addi a5, a5, 8*2*2
    gs_bfu_vv_x8  v16, v18, v20, v22, v24, v26, v28, v30,  v17, v19, v21, v23, v25, v27, v29, v31,  v5,  v4,  v5,  v4,  v5,  v4,  v5,  v4,   v5,  v4,  v5,  v4,  v5,  v4,  v5,  v4,  t0,  v8,  v9,  v10, v11, v12, v13, v14, v15
    // shuffle4
    addi t2, a1, _MASK_01230123*2
     addi t3, a1, _MASK_45674567*2
     li t6, 0x0f
    ...
    gs_bfu_vx_x8  v0,  v8,  v1,  v9,  v2,  v10, v3,  v11,  v4,  v12, v5,  v13, v6,  v14, v7,  v15,  v16, v20, v24, v28, v17, v21, v25, v29,  v18, v22, v26, v30, v19, v23, v27, v31,  t2,  t3,  t2,  t3,  t2,  t3,  t2,  t3,  t2,  t3,  t2,  t3,  t2,  t3,  t2,  t3, t0
...
start:
    ...
    vsetvli a7, a7, e16, m8, tu, mu
start_1:
    addi a6, a0, (64+0*128)*2
    vle16.v v0, (a5)
    vle16.v v8, (a6)
    li t3, -10079
    li t2, 1441     // qinv*(mont^2/128) and mont^2/128
    addi a5, a1, _ZETA_EXP_INTT_0TO5_P0_L0*2
    // Through exhaustive testing, it is found that for any 16-bit signed
    // number, after using Montgomery modular multiplication to multiply
    // the mont^2/128 constant, the coefficient range is [-1999,1999]. Note
    // that 1999/3329 is approximately 0.6005.
...
start_2:
    ...
    vrgather.vv v10, v23, v1
    vrgather.vv v11, v22, v1
    ...
    vrgather.vv v9, v28, v1
    vrgather.vv v10, v31, v1
    vrgather.vv v11, v30, v1
    vmerge.vvm  v28, v8, v28, v0
    vmerge.vvm  v29, v29, v9, v0
    vmerge.vvm  v30, v10, v30, v0
    ...
    vsub.vv  v16, v16, v8
    vsub.vv  v18, v18, v9
    vrgather.vv v8, v27, v1
    vrgather.vv v9, v25, v2
    vrgather.vv v10, v31, v1
    vrgather.vv v11, v29, v2
    vmerge.vvm  v25, v8, v25, v0
    vmerge.vvm  v27, v27, v9, v0
...
end_2:
    vsetvli a7, a7, e16, m8, tu, mu
start_3:
    addi a6, a0, (64+1*128)*2
    vle16.v v0, (a5)
    vle16.v v8, (a6)
    li t3, -10079
    li t2, 1441     // qinv*(mont^2/128) and mont^2/128
    addi a5, a1, _ZETA_EXP_INTT_0TO5_P1_L0*2
    // Through exhaustive testing, it is found that for any 16-bit signed
    // number, after using Montgomery modular multiplication to multiply
    // the mont^2/128 constant, the coefficient range is [-1999,1999]. Note
    // that 1999/3329 is approximately 0.6005.
