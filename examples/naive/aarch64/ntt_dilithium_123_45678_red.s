...
.text
        ...
        .global ntt_dilithium_123_45678_red
        .global _ntt_dilithium_123_45678_red
...
ntt_dilithium_123_45678_red:
_ntt_dilithium_123_45678_red:
        push_stack
...
layer45678_start:
        ...
        transpose4 data0, data1, data2, data3
        transpose4 data4, data5, data6, data7
        barrett_reduce data0, data1, data2, data3
        barrett_reduce data4, data5, data6, data7
        store_vectors_with_inc data0, data1, data2, data3, inp,  16*8
        store_vectors_with_inc data4, data5, data6, data7, inpp, 16*8
