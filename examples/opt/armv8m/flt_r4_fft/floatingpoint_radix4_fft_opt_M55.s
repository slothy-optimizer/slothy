...
.endm
        ...
        vldrw.32 q4, [r0]
        vldrw.32 q6, [r5]
        vadd.F32 q7, q4, q2// a+c
        vsub.F32 q1, q4, q2// a-c
        sub lr, lr, #1
.p2align 2
flt_radix4_fft_loop_start:
        ...
        vstrw.32 q3, [r3], #16            // ............*.................
        vcadd.F32 q5, q1, q0, #90         // .............*................
        vcadd.F32 q7, q1, q0, #270        // ...............*..............
        vldrw.S32 q1, [r7], #16           // ................*.............
        vcmul.F32 q3, q1, q7, #0          // .................*............
        vldrw.32 q6, [r5, #16]            // ..................e...........
        vcmla.F32 q3, q1, q7, #270        // ...................*..........
        vldrw.S32 q0, [r8], #16           // ....................*.........
        ...
        vldrw.32 q4, [r3]
        vsub.F32 q0, q4, q6// b-d
        vadd.F32 q5, q4, q6// b+d
        vadd.F32 q6, q7, q5// a+b+c+d
        vsub.F32 q5, q7, q5// a-b+c-d
        vldrw.S32 q7, [r6], #16
        vcmul.F32 q3, q7, q5, #0
        vstrw.32 q6, [r0], #16
        vcmla.F32 q3, q7, q5, #270
        vstrw.32 q3, [r3], #16
        vcadd.F32 q5, q1, q0, #90// a+ib-c-id
        vcadd.F32 q7, q1, q0, #270// a-ib-c+id
        vldrw.S32 q1, [r7], #16
        vcmul.F32 q3, q1, q7, #0
        vcmla.F32 q3, q1, q7, #270
        vldrw.S32 q0, [r8], #16
