...
ntt_rvv_vlen128_opt_c908:
    ...
    // Preamble
        li x29, 8*8                                   // *.............................................................................
        li x5, 3329                                   // *.............................................................................
        vsetvli x29, x29, e16, m8, tu, mu             // .*............................................................................
        addi x16, x11, _ZETAS_EXP*2                   // .*............................................................................
        li x27, -3327                                 // ..*...........................................................................
        lh x28, 0*2(x16)                              // ..*...........................................................................
        lh x7, 1*2(x16)                               // ...*..........................................................................
        addi x15, x10, 128*2                          // ...*..........................................................................
        vle16.v v16, (x10)                            // .....*........................................................................ // @slothy:lmul=8
        vle16.v v24, (x15)                            // .......*...................................................................... // @slothy:lmul=8
        vmul.vx v0, v24, x28                          // ..........*................................................................... // @slothy:lmul=8
        vmulh.vx v24, v24, x7                         // ..........*................................................................... // @slothy:lmul=8
        vmulh.vx v0, v0, x5                           // ..............*............................................................... // @slothy:lmul=8
        vsub.vv v0, v24, v0                           // ..................*........................................................... // @slothy:lmul=8
        vsub.vv v24, v16, v0                          // ......................*....................................................... // @slothy:lmul=8
        vadd.vv v16, v16, v0                          // ......................*....................................................... // @slothy:lmul=8
        vse16.v v16, (x10)                            // ..........................*................................................... // @slothy:lmul=8
        vse16.v v24, (x15)                            // ............................*................................................. // @slothy:lmul=8
        addi x14, x10, 64*2                           // ............................*.................................................
        addi x15, x15, 64*2                           // .............................*................................................
        vle16.v v16, (x14)                            // ..............................*............................................... // @slothy:lmul=8
        vle16.v v8, (x15)                             // ................................*............................................. // @slothy:lmul=8
        vmul.vx v0, v8, x28                           // ...................................*.......................................... // @slothy:lmul=8
        vmulh.vx v8, v8, x7                           // ...................................*.......................................... // @slothy:lmul=8
    // Kernel
        start:
                                                      // Instructions:    48
                                                      // Expected cycles: 74
                                                      ...
                                                      // |------------------------|------------------------|-----------------------
        vmulh.vx v0, v0, x5                           // *......................................................................... // @slothy:lmul=8
        vsub.vv v0, v8, v0                            // ....*..................................................................... // @slothy:lmul=8
        vadd.vv v8, v16, v0                           // ........*................................................................. // @slothy:lmul=8
        vsub.vv v24, v16, v0                          // ........*................................................................. // @slothy:lmul=8
        vse16.v v8, (x14)                             // ............*............................................................. // @slothy:lmul=8
        vse16.v v24, (x15)                            // ..............*........................................................... // @slothy:lmul=8
        li x16, 8*8                                   // ..............*...........................................................
        vsetvli x16, x16, e16, m8, tu, mu             // ...............*..........................................................
        addi x16, x11, _ZETAS_EXP_1TO6_P0_L1*2        // ...............*..........................................................
        addi x14, x10, (0*128)*2                      // ................*.........................................................
        addi x15, x10, (64+0*128)*2                   // ................*.........................................................
        lh x28, 0*2(x16)                              // .................*........................................................
        lh x7, 1*2(x16)                               // ..................*.......................................................
        vle16.v v16, (x14)                            // ...................*...................................................... // @slothy:lmul=8
        vle16.v v8, (x15)                             // .....................*.................................................... // @slothy:lmul=8
        vmul.vx v0, v8, x28                           // ........................*................................................. // @slothy:lmul=8
        vmulh.vx v8, v8, x7                           // ........................*................................................. // @slothy:lmul=8
        vmulh.vx v24, v0, x5                          // ............................*............................................. // @slothy:lmul=8
        vsub.vv v0, v8, v24                           // ................................*......................................... // @slothy:lmul=8
        vadd.vv v8, v16, v0                           // ....................................*..................................... // @slothy:lmul=8
