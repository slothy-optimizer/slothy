...
poly_basemul_rvv_vlen128_loop:
                                     ...
                                     // 0                        25
                                     // |------------------------|
        vle32.v v16, (x12)           // *................................................. // @slothy:lmul=8 // @slothy:sew=32
        addi x12, x12, 4*4*8         // *.................................................
        vle32.v v24, (x11)           // ..*............................................... // @slothy:lmul=8 // @slothy:sew=32
        addi x11, x11, 4*4*8         // ..*...............................................
        vmulh.vv v0, v24, v16        // .....*............................................ // @slothy:lmul=8 // @slothy:sew=32
        vmul.vv v8, v24, v16         // ......*........................................... // @slothy:lmul=8 // @slothy:sew=32
        vmul.vx v8, v8, x6           // .......................*.......................... // @slothy:lmul=8 // @slothy:sew=32
        vmulh.vx v24, v8, x5         // ...............................*.................. // @slothy:lmul=8 // @slothy:sew=32
        vsub.vv v8, v0, v24          // .........................................*........ // @slothy:lmul=8 // @slothy:sew=32
        vse32.v v8, (x10)            // .................................................* // @slothy:lmul=8 // @slothy:sew=32
        addi x10, x10, 4*4*8         // .................................................*
        ...
        addi t2, t2, -1
        bnez t2, poly_basemul_rvv_vlen128_loop
