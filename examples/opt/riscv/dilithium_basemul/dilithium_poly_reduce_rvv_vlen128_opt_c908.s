...
poly_reduce_rvv_vlen128_opt_c908:
    ...
    addi a4, a0, 0
        addi x19, x10, 4*4*8          // *.............................
        vle32.v v8, (x19)             // .*............................ // @slothy:lmul=8
        vle32.v v0, (x10)             // ...*.......................... // @slothy:lmul=8
        addi x10, x10, 4*4*8*2        // ...*..........................
        vadd.vx v24, v8, x11          // .....*........................ // @slothy:lmul=8
        vadd.vx v16, v0, x11          // .......*...................... // @slothy:lmul=8
        vsra.vi v16, v16, 23          // ...........*.................. // @slothy:lmul=8
        vsra.vi v24, v24, 23          // ............*................. // @slothy:lmul=8
        addi a3, a3, -1
poly_reduce_rvv_vlen128_loop:
                                      ...
                                      // 0                        25
                                      // |------------------------|----
        vmul.vx v24, v24, x12         // *............................. // @slothy:lmul=8
        addi x19, x14, 4*4*8          // *.............................
        vsub.vv v8, v8, v24           // ....*......................... // @slothy:lmul=8
        vmul.vx v24, v16, x12         // ......*....................... // @slothy:lmul=8
        vsub.vv v0, v0, v24           // ..........*................... // @slothy:lmul=8
        vse32.v v0, (x14)             // ..............*............... // @slothy:lmul=8
        vse32.v v8, (x19)             // ................*............. // @slothy:lmul=8
        addi x14, x14, 4*4*8*2        // ................*.............
        addi x19, x10, 4*4*8          // .................*............
        vle32.v v8, (x19)             // ..................*........... // @slothy:lmul=8
        vle32.v v0, (x10)             // ....................*......... // @slothy:lmul=8
        addi x10, x10, 4*4*8*2        // ....................*.........
        ...
        addi a3, a3, -1
        bnez a3, poly_reduce_rvv_vlen128_loop
        vmul.vx v16, v16, x12         // ...............*.............. // @slothy:lmul=8
        vmul.vx v24, v24, x12         // .................*............ // @slothy:lmul=8
        vsub.vv v24, v8, v24          // .....................*........ // @slothy:lmul=8
        addi x19, x14, 4*4*8          // .....................*........
        vsub.vv v8, v0, v16           // .......................*...... // @slothy:lmul=8
        vse32.v v8, (x14)             // ...........................*.. // @slothy:lmul=8
        addi x14, x14, 4*4*8*2        // ...........................*..
        vse32.v v24, (x19)            // .............................* // @slothy:lmul=8
    restore_regs
ret