...
rej_uniform_rvv_vlen128_loop_x4:
        start:
                                                ...
                                                // 0                        25                       50
                                                // |------------------------|------------------------|
        vsetivli x22, 16, e8, m1, tu, mu        // *..........................................................................
        addi x25, x11, 24                       // *..........................................................................
        addi x22, x11, 12                       // .*.........................................................................
        addi x13, x11, 36                       // ..*........................................................................
        vle8.v v2, (x11)                        // ....*...................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v24, (x22)                       // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v3, (x25)                        // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v16, (x13)                       // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v29, v2, v30                // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v4, v24, v30                // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v10, v3, v30                // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v15, v16, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x27, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v29, v29, 4, v0.t               // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v10, v10, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v4, v4, 4, v0.t                 // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v3, v10, x5                     // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v24, v29, x5                    // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v15, v15, 4, v0.t               // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v28, v24, x6                  // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v4, v4, x5                      // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v22, v24, v28              // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x4, v28                         // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v12, v4, x6                   // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v6, v15, x5                     // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v31, v3, x6                   // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x13, v12                        // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        add x4, x4, x4                          // .........................................................*.................
        vmsltu.vx v13, v6, x6                   // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v10, v4, v12               // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v31                        // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v22, (x10)                      // ..............................................................*............ // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x4                        // ..............................................................*............
        vse16.v v10, (x10)                      // ................................................................*.......... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x20, v13                        // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v29, v3, v31               // ..................................................................*........ // @slothy:lmul=1 // @slothy:sew=16
        add x24, x13, x13                       // ...................................................................*.......
        add x10, x10, x24                       // ....................................................................*......
        add x17, x27, x27                       // ....................................................................*......
        add x18, x10, x17                       // .....................................................................*.....
        vcompress.vm v10, v6, v13               // .....................................................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v29, (x10)                      // ........................................................................*.. // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x22, x20, x20                       // .........................................................................*.
        vse16.v v10, (x18)                      // ..........................................................................* // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x18, x22                       // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        addi x11, x11, 12*2                    // ....*.......................................
        vle8.v v2, (x22)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v29, v15, v30              // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v4, v2, v30                // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v29, v29, 4, v0.t              // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v4, v4, 4, v0.t                // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v2, v29, x5                    // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v5, v4, x5                     // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v22, v2, x6                  // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v24, v5, x6                  // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v29, v2, v22              // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x13, v22                       // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v10, v5, v24              // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v24                       // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v29, (x10)                     // ........................................*... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x9, x13, x13                       // .........................................*..
        add x22, x10, x9                       // ..........................................*.
        add x19, x27, x27                      // ..........................................*.
        vse16.v v10, (x22)                     // ...........................................* // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x22, x19                      // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        start_x1:
                                                ...
                                                // |------------------------|--------
        vsetivli x22, 16, e8, m1, tu, mu        // *.................................
        vle8.v v4, (x11)                        // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v29, v4, v30                // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // .......*..........................
        vsrl.vi v29, v29, 4, v0.t               // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v4, v29, x5                     // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v10, v4, x6                   // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v10                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v29, v4, v10               // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x13, x22, x22                       // ...............................*..
        vse16.v v29, (x10)                      // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x13                       // .................................*
