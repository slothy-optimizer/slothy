...
rej_uniform_rvv_vlen128_loop_x4:
        start:
                                                ...
                                                // 0                        25                       50
                                                // |------------------------|------------------------|
        vsetivli x15, 16, e8, m1, tu, mu        // *..........................................................................
        addi x17, x11, 36                       // *..........................................................................
        addi x15, x11, 12                       // .*.........................................................................
        addi x31, x11, 24                       // ..*........................................................................
        vle8.v v12, (x11)                       // ....*...................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v6, (x15)                        // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v22, (x31)                       // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v7, (x17)                        // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v23, v6, v30                // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v15, v12, v30               // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v7, v30                // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v14, v22, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x18, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v15, v15, 4, v0.t               // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v16, v16, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v12, v15, x5                    // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v23, v23, 4, v0.t               // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v13, v12, x6                  // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        ...
        vmsltu.vx v20, v27, x6                  // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v7, v14, x5                     // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ..................................................*........................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x12, v20                        // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v10, v7, x6                   // ....................................................*...................... // @slothy:lmul=1 // @slothy:sew=16
        add x19, x8, x8                         // .....................................................*.....................
        add x22, x10, x19                       // ......................................................*....................
        vmsltu.vx v4, v16, x6                   // ......................................................*.................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v23, v27, v20              // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x15, v10                        // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        add x9, x12, x12                        // ...........................................................*...............
        vcompress.vm v14, v16, v4               // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x17, v4                         // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v12, v13              // ..............................................................*............ // @slothy:lmul=1 // @slothy:sew=16
        add x4, x15, x15                        // .................................................................*.........
        vcompress.vm v16, v7, v10               // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        add x29, x22, x9                        // ..................................................................*........
        add x30, x29, x4                        // ...................................................................*.......
        vse16.v v14, (x30)                      // ....................................................................*...... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v23, (x22)                      // ......................................................................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x24, x17, x17                       // .......................................................................*...
        vse16.v v16, (x29)                      // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        addi x11, x11, 12*2                     // ....*.......................................
        vle8.v v14, (x15)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v15, v16, v30               // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v23, v14, v30               // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x17, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v15, v15, 4, v0.t               // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v23, v23, 4, v0.t               // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v6, v15, x5                     // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v27, v23, x5                    // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v7, v6, x6                    // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v16, v27, x6                  // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x8, v7                          // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x15, v16                        // ..................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v6, v7                // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        add x8, x8, x8                          // ....................................*.......
        add x17, x10, x8                        // .....................................*......
        vcompress.vm v14, v27, v16              // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v15, (x10)                      // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x8, x15, x15                        // ..........................................*.
        vse16.v v14, (x17)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x17, x8                        // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        ...
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v15, v14, v30               // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x15, 8, e16, m1, tu, mu        // .......*..........................
        vsrl.vi v15, v15, 4, v0.t               // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v15, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v23, v16, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x15, v23                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v16, v23              // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x17, x15, x15                       // ...............................*..
        vse16.v v15, (x10)                      // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x17                       // .................................*
