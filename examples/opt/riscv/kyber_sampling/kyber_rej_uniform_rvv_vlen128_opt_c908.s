...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x1, x11, 24                        // .*.........................................................................
        vle8.v v4, (x1)                         // ....*...................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x26, x11, 36                       // .....*.....................................................................
        vle8.v v28, (x26)                       // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v4, v30                // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v29, (x9)                        // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v18, (x11)                       // ..............*............................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v4, v28, v30                // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v26, v29, v30               // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                     // ....................*......................................................
        vrgather.vv v23, v18, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x30, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v28, v23, 4, v0.t               // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v26, v26, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v28, v28, x5                    // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v16, v16, 4, v0.t               // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v23, v28, x6                  // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v26, v26, x5                    // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x30, v23                        // .............................................*............................. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v19, v28, v23              // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v4, v4, 4, v0.t                 // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v23, v16, x6                  // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v28, v26, x6                  // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        add x30, x30, x30                       // .....................................................*.....................
        add x30, x10, x30                       // ......................................................*....................
        vand.vx v4, v4, x5                      // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x26, v23                        // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v19, (x10)                      // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v19, v4, x6                   // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x1, v28                         // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v5, v26, v28               // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v26, v16, v23              // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x10, v19                        // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v5, (x30)                       // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x1, x1, x1                          // .....................................................................*.....
        vcompress.vm v16, v4, v19               // .....................................................................*..... // @slothy:lmul=1 // @slothy:sew=16
        add x30, x30, x1                        // ......................................................................*....
        add x1, x26, x26                        // .......................................................................*...
        add x1, x30, x1                         // ........................................................................*..
        vse16.v v26, (x30)                      // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x30, x10, x10                       // .........................................................................*.
        vse16.v v16, (x1)                       // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x1, x30                        // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        vsetivli x30, 16, e8, m1, tu, mu        // *...........................................
        addi x30, x11, 12                       // *...........................................
        vle8.v v26, (x11)                       // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                     // ....*.......................................
        vle8.v v16, (x30)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v28, v26, v30               // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v26, v16, v30               // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x30, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v16, v28, 4, v0.t               // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v26, v26, 4, v0.t               // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v26, v26, x5                    // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v28, v16, x6                  // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v4, v26, x6                   // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x30, v28                        // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x1, v4                          // ..................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v23, v16, v28              // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        add x30, x30, x30                       // ....................................*.......
        add x30, x10, x30                       // .....................................*......
        vcompress.vm v16, v26, v4               // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v23, (x10)                      // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x1, x1, x1                          // ..........................................*.
        vse16.v v16, (x30)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x30, x1                        // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        ...
        vle8.v v26, (x11)                       // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v16, v26, v30               // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x30, 8, e16, m1, tu, mu        // .......*..........................
        vsrl.vi v26, v16, 4, v0.t               // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v26, v26, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v16, v26, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x30, v16                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v28, v26, v16              // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x30, x30, x30                       // ...............................*..
        vse16.v v28, (x10)                      // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x30                       // .................................*
