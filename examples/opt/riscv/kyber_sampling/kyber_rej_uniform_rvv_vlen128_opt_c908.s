...
.macro rej_core_x2 vr0, vr1, vf0, vf1, vt0, vt1, vidx, x0xfff, xq
    ...
    vse16.v \vr0, (a0)  // @slothy:reads=out_mem // @slothy:writes=out_mem
    add t2, t2, t2
    add t3, t3, t3

    add a0, a0, t2
    vse16.v \vr1, (a0)  // @slothy:reads=out_mem // @slothy:writes=out_mem
    add a0, a0, t3
.endm
...
.macro rej_core_x4 vr0, vr1, vr2, vr3, vf0, vf1, vf2, vf3,  vt0, vt1, vt2, vt3, vidx, x0xfff, xq
    ...
    vse16.v \vr1, (a0)  // @slothy:reads=out_mem // @slothy:writes=out_mem
    add a0, a0, t3
    vse16.v \vr2, (a0)  // @slothy:reads=out_mem // @slothy:writes=out_mem
    add a0, a0, t4
    add t5, t5, t5
    vse16.v \vr3, (a0)  // @slothy:reads=out_mem // @slothy:writes=out_mem
    add a0, a0, t5
.endm
...
rej_uniform_rvv_vlen128_opt_c908:
    ...
    addi a5, a0, 0
    addi a6, a1, 0
// do...while(ctr <= KYBER_N - 8*4 && pos <= REJ_UNIFORM_VECTOR_BUFLEN - 12*4)
rej_uniform_rvv_vlen128_loop_x4:
        start:
                                                // Instructions:    46
                                                // Expected cycles: 75
                                                // Expected IPC:    0.61
        ...
        addi x9, x11, 36                        // .*.........................................................................
        addi x13, x11, 24                       // ..*........................................................................
        vle8.v v15, (x11)                       // ....*...................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v3, (x13)                        // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v17, (x24)                       // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v26, (x9)                        // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v12, v3, v30                // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v23, v26, v30               // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v9, v17, v30                // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v15, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x8, 8, e16, m1, tu, mu         // ........................*..................................................
        vsrl.vi v16, v16, 4, v0.t               // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v23, v23, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v27, v23, x5                    // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v2, v16, x6                   // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v9, v9, 4, v0.t                 // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v31, v27, x6                  // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x15, v2                         // .............................................*............................. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v16, v2               // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v28, v9, x5                     // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v12, v12, 4, v0.t               // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        add x20, x15, x15                       // .....................................................*.....................
        vmsltu.vx v10, v28, x6                  // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        add x20, x10, x20                       // ......................................................*....................
        vcpop.m x8, v31                         // ......................................................*.................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v22, v12, x5                    // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v3, v27, v31               // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x4, v10                         // ..........................................................*................ // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v5, v22, x6                   // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v9, v28, v10               // ..............................................................*............ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x15, v5                         // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v15, (x10)                      // .................................................................*......... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x27, x4, x4                         // ..................................................................*........
        vcompress.vm v16, v22, v5               // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x10, x20, x27                       // ...................................................................*.......
        vse16.v v9, (x20)                       // ......................................................................*.... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x20, x8, x8                         // ......................................................................*....
        add x15, x15, x15                       // ........................................................................*..
        vse16.v v16, (x10)                      // ........................................................................*.. // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x15                       // .........................................................................*.
        vse16.v v3, (x10)                       // ..........................................................................* // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x20                       // ..........................................................................*
        ...
        // vle8.v v15, (x29)                     // ..........*................................................................
        // addi x11, x11, 12*4                   // ....*......................................................................
        // vrgather.vv v16, v12, v30             // ........................*..................................................
        // vrgather.vv v17, v13, v30             // ....................*......................................................
        // vrgather.vv v18, v14, v30             // ............*..............................................................
        // vrgather.vv v19, v15, v30             // ................*..........................................................
        // vsetivli x17, 8, e16, m1, tu, mu      // ........................*..................................................
        // vsrl.vi   v16, v16, 4, v0.t           // ................................*..........................................
        // vsrl.vi   v17, v17, 4, v0.t           // ..........................................*................................
        // vsrl.vi   v18, v18, 4, v0.t           // ...................................................*.......................
        // vsrl.vi   v19, v19, 4, v0.t           // ..................................*........................................
        // vand.vx   v16, v16, x5                // ....................................*......................................
        // vand.vx   v17, v17, x5                // .................................................*.........................
        // vand.vx   v18, v18, x5                // .......................................................*...................
        // vand.vx   v19, v19, x5                // ......................................*....................................
        // vmsltu.vx v12, v16, x6                // ........................................*..................................
        // vmsltu.vx v13, v17, x6                // .....................................................*.....................
        // vmsltu.vx v14, v18, x6                // ............................................................*..............
        // vmsltu.vx v15, v19, x6                // ............................................*..............................
        // vcpop.m   x7, v12                     // .............................................*.............................
        // vcpop.m   x28, v13                    // ..........................................................*................
        // vcpop.m   x29, v14                    // ................................................................*..........
        // vcpop.m   x30, v15                    // ......................................................*....................
        // vcompress.vm v8, v16, v12             // ..............................................*............................
        // vcompress.vm v9, v17, v13             // ..............................................................*............
        // vcompress.vm v10, v18, v14            // ...................................................................*.......
        // vcompress.vm v11, v19, v15            // .........................................................*.................
        // vse16.v v8, (x10)                     // .................................................................*.........
        // add x7, x7, x7                        // .....................................................*.....................
        // add x28, x28, x28                     // ..................................................................*........
        // add x10, x10, x7                      // ......................................................*....................
    ...
    sub t3, a1, a6
    li   t5, 504-12*4
    bgtu t2, t4, rej_uniform_rvv_vlen128_loopend_x4
    bleu t3, t5, rej_uniform_rvv_vlen128_loop_x4
rej_uniform_rvv_vlen128_loopend_x4:
// while(ctr <= KYBER_N - 8*2 && pos <= REJ_UNIFORM_VECTOR_BUFLEN - 12*2)
rej_uniform_rvv_vlen128_loop_x2:
    sub  t2, a0, a5
    li  t4, 256-8*2
    srli t2, t2, 1
    sub t3, a1, a6
    li   t5, 504-12*2
    bgtu t2, t4, rej_uniform_rvv_vlen128_loopend_x2
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        start_x2:
                                               // Instructions:    24
                                               // Expected cycles: 44
                                               // Expected IPC:    0.55
                                               ...
                                               // 0                        25
                                               // |------------------------|------------------
        vsetivli x9, 16, e8, m1, tu, mu        // *...........................................
        addi x24, x11, 12                      // *...........................................
        vle8.v v12, (x11)                      // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                    // ....*.......................................
        vle8.v v23, (x24)                      // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v12, v30              // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v9, v23, v30               // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v16, v16, 4, v0.t              // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v9, v9, 4, v0.t                // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v22, v16, x5                   // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v13, v9, x5                    // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v27, v22, x6                 // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v15, v13, x6                 // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v23, v22, v27             // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x24, v27                       // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v16, v13, v15             // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x31, v15                       // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v23, (x10)                     // ........................................*... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x8, x24, x24                       // .........................................*..
        add x15, x10, x8                       // ..........................................*.
        add x4, x31, x31                       // ..........................................*.
        vse16.v v16, (x15)                     // ...........................................* // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x15, x4                       // ...........................................*
    ...
    j rej_uniform_rvv_vlen128_loop_x2
rej_uniform_rvv_vlen128_loopend_x2:
// while(ctr <= KYBER_N - 8 && pos <= REJ_UNIFORM_VECTOR_BUFLEN - 12)
rej_uniform_rvv_vlen128_loop_x1:
    sub  t2, a0, a5
    li  t4, 256-8
    srli t2, t2, 1
    sub t3, a1, a6
    li   t5, 504-12
    bgtu t2, t4, rej_uniform_rvv_vlen128_loopend_x1
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        start_x1:
                                                // Instructions:    13
                                                // Expected cycles: 34
                                                // Expected IPC:    0.38
                                                ...
                                                // |------------------------|--------
        vsetivli x24, 16, e8, m1, tu, mu        // *.................................
        vle8.v v9, (x11)                        // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v16, v9, v30                // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu         // .......*..........................
        vsrl.vi v16, v16, 4, v0.t               // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v23, v16, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x24, v23                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v9, v16, v23               // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x9, x24, x24                        // ...............................*..
        vse16.v v9, (x10)                       // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x9                        // .................................*
    ...
    j rej_uniform_rvv_vlen128_loop_x1
rej_uniform_rvv_vlen128_loopend_x1:
    sw t2, (a3)
    sw t3, (a4)
    restore_regs
ret