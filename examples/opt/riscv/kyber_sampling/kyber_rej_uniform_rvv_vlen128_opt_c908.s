...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v13, (x30)                       // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v28, v9, v30                // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v6, (x24)                        // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v13, v30               // ..............*............................................................ // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v13, (x19)                       // ..................*........................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v14, v6, v30                // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v10, v13, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x30, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v7, v14, 4, v0.t                // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v19, v16, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v3, v7, x5                      // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v13, v28, 4, v0.t               // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v6, v3, x6                    // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v13, x5                    // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v21, v10, 4, v0.t               // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v13, v16, x6                  // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v6                         // ...............................................*........................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v9, v21, x5                     // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v14, v16, v13              // ..................................................*........................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x30, v13                        // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v10, v9, x6                   // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        add x19, x27, x27                       // .......................................................*...................
        vand.vx v23, v19, x5                    // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v28, v3, v6                // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x24, v10                        // ..........................................................*................ // @slothy:lmul=1 // @slothy:sew=16
        add x14, x30, x30                       // ...........................................................*...............
        add x18, x10, x14                       // ............................................................*..............
        vmsltu.vx v12, v23, x6                  // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        add x14, x18, x19                       // .............................................................*.............
        vse16.v v14, (x10)                      // ..............................................................*............ // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v14, v9, v10               // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x30, v12                        // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        add x27, x24, x24                       // ..................................................................*........
        add x27, x14, x27                       // ...................................................................*.......
        vcompress.vm v3, v23, v12               // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v28, (x18)                      // ......................................................................*.... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v3, (x27)                       // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x9, x30, x30                        // .........................................................................*.
        vse16.v v14, (x14)                      // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x27, x9                        // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        vle8.v v9, (x11)                        // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                     // ....*.......................................
        vle8.v v3, (x24)                        // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v14, v9, v30                // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v9, v3, v30                 // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x24, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v14, v14, 4, v0.t               // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v16, v9, 4, v0.t                // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v12, v14, x5                    // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v9, v16, x5                     // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v16, v12, x6                  // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v11, v9, x6                   // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v16                        // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x16, v11                        // ..................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v3, v12, v16               // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        add x30, x27, x27                       // ....................................*.......
        add x15, x10, x30                       // .....................................*......
        vcompress.vm v14, v9, v11               // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v3, (x10)                       // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x10, x16, x16                       // ..........................................*.
        vse16.v v14, (x15)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x15, x10                       // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        ...
        vsetivli x24, 8, e16, m1, tu, mu        // ...........*......................
        vsrl.vi v16, v9, 4, v0.t                // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v28, v16, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v10, v28, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x13, v10                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v14, v28, v10              // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x27, x13, x13                       // ...............................*..
        vse16.v v14, (x10)                      // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x27                       // .................................*
