...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v3, (x22)                        // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v21, (x7)                        // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v5, (x20)                        // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v2, v6, v30                 // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v9, v3, v30                 // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v19, v21, v30               // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v4, v5, v30                 // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v1, v2, 4, v0.t                 // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v21, v9, 4, v0.t                // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v15, v1, x5                     // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v3, v21, x5                     // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v29, v15, x6                  // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v2, v19, 4, v0.t                // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v27, v3, x6                   // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x8, v29                         // .............................................*............................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v19, v2, x5                     // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v5, v4, 4, v0.t                 // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x20, v27                        // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v4, v19, x6                   // ..................................................*........................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v8, v5, x5                      // ....................................................*...................... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x8, x8                         // .....................................................*.....................
        add x23, x10, x22                       // ......................................................*....................
        vcompress.vm v17, v3, v27               // ......................................................*.................... // @slothy:lmul=1 // @slothy:sew=16
        add x15, x20, x20                       // .........................................................*.................
        vmsltu.vx v1, v8, x6                    // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        add x15, x23, x15                       // ..........................................................*................
        vcpop.m x22, v4                         // ..........................................................*................ // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v17, (x23)                      // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v13, v15, v29              // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x23, v1                         // ..............................................................*............ // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v5, v8, v1                 // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v21, v19, v4               // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // ....................................................................*......
        add x20, x15, x22                       // .....................................................................*.....
        vse16.v v13, (x10)                      // ......................................................................*.... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v21, (x15)                      // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x22, x23, x23                       // .........................................................................*.
        add x10, x20, x22                       // ..........................................................................*
        vse16.v v5, (x20)                       // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        start_x2:
                                                ...
                                                // 0                        25
                                                // |------------------------|------------------
        vsetivli x16, 16, e8, m1, tu, mu        // *...........................................
        addi x24, x11, 12                       // *...........................................
        vle8.v v9, (x24)                        // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v16, (x11)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                     // ......*.....................................
        vrgather.vv v4, v9, v30                 // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v18, v16, v30               // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x24, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v11, v18, 4, v0.t               // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v9, v4, 4, v0.t                 // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v4, v11, x5                     // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v17, v9, x5                     // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v31, v4, x6                   // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v29, v17, x6                  // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v31                        // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v13, v4, v31               // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x20, v29                        // ....................................*....... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v26, v17, v29              // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // ........................................*...
        vse16.v v13, (x10)                      // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x24, x10, x22                       // .........................................*..
        add x4, x20, x20                        // ..........................................*.
        vse16.v v26, (x24)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x24, x4                        // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        start_x1:
                                                ...
                                                // |------------------------|--------
        vsetivli x22, 16, e8, m1, tu, mu        // *.................................
        vle8.v v1, (x11)                        // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v5, v1, v30                 // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // ...........*......................
        vsrl.vi v5, v5, 4, v0.t                 // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v1, v5, x5                      // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v21, v1, x6                   // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v21                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v5, v1, v21                // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // ...............................*..
        vse16.v v5, (x10)                       // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x22                       // .................................*
