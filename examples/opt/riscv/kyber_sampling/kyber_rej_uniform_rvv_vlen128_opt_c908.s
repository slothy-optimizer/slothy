...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x27, x11, 24                       // .....*.....................................................................
        vle8.v v25, (x27)                       // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                     // ......*....................................................................
        vle8.v v5, (x20)                        // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v18, v16, v30               // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v16, v25, v30               // ..............*............................................................ // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v9, (x22)                        // ..................*........................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v25, v5, v30                // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v2, v9, v30                 // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v2, v2, 4, v0.t                 // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v5, v18, 4, v0.t                // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v2, v2, x5                      // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v5, v5, x5                      // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v16, v16, 4, v0.t               // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v18, v5, x6                   // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v25, v25, 4, v0.t               // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v18                        // ...............................................*........................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v9, v5, v18                // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v18, v16, x6                  // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v5, v2, x6                    // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v25, v25, x5                    // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // .......................................................*...................
        add x22, x10, x22                       // ........................................................*..................
        vcpop.m x20, v18                        // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v9, (x10)                       // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v9, v25, x6                   // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v5                         // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v28, v2, v5                // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v2, v16, v18               // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x7, v9                          // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v16, v25, v9               // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x27, x27, x27                       // .....................................................................*.....
        vse16.v v28, (x22)                      // ......................................................................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x27                       // ......................................................................*....
        add x27, x20, x20                       // .......................................................................*...
        vse16.v v2, (x22)                       // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x27, x22, x27                       // ........................................................................*..
        add x22, x7, x7                         // .........................................................................*.
        vse16.v v16, (x27)                      // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x27, x22                       // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        addi x11, x11, 12*2                     // ....*.......................................
        vle8.v v16, (x22)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v5, v2, v30                 // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v2, v16, v30                // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v16, v5, 4, v0.t                // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v2, v2, 4, v0.t                 // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v16, x5                    // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v2, v2, x5                      // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v5, v16, x6                   // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v25, v2, x6                   // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v5                         // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x27, v25                        // ..................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v18, v16, v5               // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // ....................................*.......
        add x22, x10, x22                       // .....................................*......
        vcompress.vm v16, v2, v25               // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v18, (x10)                      // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x27, x27, x27                       // ..........................................*.
        vse16.v v16, (x22)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x22, x27                       // ...........................................*
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        start_x1:
                                                ...
                                                // |------------------------|--------
        vsetivli x22, 16, e8, m1, tu, mu        // *.................................
        vle8.v v5, (x11)                        // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                       // ....*.............................
        vrgather.vv v2, v5, v30                 // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x22, 8, e16, m1, tu, mu        // ...........*......................
        vsrl.vi v2, v2, 4, v0.t                 // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v5, v2, x5                      // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v16, v5, x6                   // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x22, v16                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v2, v5, v16                // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x22, x22                       // ...............................*..
