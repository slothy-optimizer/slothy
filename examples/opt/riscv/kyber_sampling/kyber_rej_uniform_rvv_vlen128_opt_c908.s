...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x11, x11, 12*4                     // ....*......................................................................
        vle8.v v10, (x17)                       // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v19, (x23)                       // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v12, (x7)                        // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v7, v2, v30                 // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v24, v10, v30               // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v11, v19, v30               // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v3, v12, v30                // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x31, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v7, v7, 4, v0.t                 // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v11, v11, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v7, v7, x5                      // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v3, v3, 4, v0.t                 // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v6, v7, x6                    // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v24, v24, 4, v0.t               // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v23, v11, x5                    // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x17, v6                         // .............................................*............................. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v12, v7, v6                // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v13, v23, x6                  // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v11, v3, x5                     // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        add x8, x17, x17                        // .....................................................*.....................
        vand.vx v29, v24, x5                    // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        add x22, x10, x8                        // ......................................................*....................
        vmsltu.vx v17, v11, x6                  // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x8, v13                         // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v12, (x10)                      // .........................................................*................. // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v15, v29, x6                  // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x1, v17                         // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v7, v11, v17               // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v11, v23, v13              // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x10, v15                        // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        add x29, x8, x8                         // ...................................................................*.......
        vcompress.vm v3, v29, v15               // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x7, x1, x1                          // ....................................................................*......
        add x8, x22, x7                         // .....................................................................*.....
        vse16.v v7, (x22)                       // ......................................................................*.... // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x23, x8, x29                        // ......................................................................*....
        vse16.v v11, (x8)                       // ........................................................................*.. // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x19, x10, x10                       // .........................................................................*.
        vse16.v v3, (x23)                       // ..........................................................................* // @slothy:reads=out_mem // @slothy:writes=out_mem // @slothy:lmul=1 // @slothy:sew=16
        add x10, x23, x19                       // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        addi x11, x11, 12*2                     // ....*.......................................
        vle8.v v10, (x7)                        // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v7, v3, v30                 // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v3, v10, v30                // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x17, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v7, v7, 4, v0.t                 // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v3, v3, 4, v0.t                 // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v7, v7, x5                      // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v19, v3, x5                     // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v10, v7, x6                   // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v24, v19, x6                  // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v3, v7, v10                // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x17, v10                        // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v7, v19, v24               // ...................................*........ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x8, v24                         // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        ...
        addi x11, x11, 12                      // ....*.............................
        vrgather.vv v7, v3, v30                // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x7, 8, e16, m1, tu, mu        // .......*..........................
        vsrl.vi v7, v7, 4, v0.t                // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v3, v7, x5                     // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v24, v3, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x7, v24                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v7, v3, v24               // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x7, x7, x7                         // ...............................*..
