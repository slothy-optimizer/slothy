...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x12, x11, 24                      // .*.........................................................................
        addi x9, x11, 12                       // .*.........................................................................
        vle8.v v27, (x11)                      // ....*...................................................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*4                    // ....*......................................................................
        vle8.v v29, (x14)                      // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v19, (x12)                      // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v16, (x9)                       // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v1, v27, v30               // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v11, v29, v30              // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v27, v19, v30              // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v28, v16, v30              // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x8, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v1, v1, 4, v0.t                // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v11, v11, 4, v0.t              // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v13, v1, x5                    // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v28, v28, 4, v0.t              // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v12, v13, x6                 // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v27, v27, 4, v0.t              // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v7, v13, v12              // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x14, v12                       // .............................................*............................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v8, v27, x5                    // ...............................................*........................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v1, v28, x5                    // .................................................*......................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v18, v8, x6                  // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        add x13, x14, x14                      // .....................................................*.....................
        vmsltu.vx v16, v1, x6                  // .....................................................*..................... // @slothy:lmul=1 // @slothy:sew=16
        add x18, x10, x13                      // ......................................................*....................
        vand.vx v29, v11, x5                   // .......................................................*................... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x13, v18                       // ........................................................*.................. // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v7, (x10)                      // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v4, v29, x6                  // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x10, v16                       // ............................................................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v11, v8, v18              // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        add x13, x13, x13                      // ................................................................*..........
        vcompress.vm v27, v29, v4              // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x9, v4                         // .................................................................*......... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v19, v1, v16              // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        add x14, x10, x10                      // ....................................................................*......
        add x10, x18, x14                      // .....................................................................*.....
        add x21, x10, x13                      // ......................................................................*....
        vse16.v v11, (x10)                     // ......................................................................*.... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v19, (x18)                     // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x12, x9, x9                        // .........................................................................*.
        vse16.v v27, (x21)                     // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x21, x12                      // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        ...
        vle8.v v11, (x9)                        // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v19, (x11)                       // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                     // ......*.....................................
        vrgather.vv v28, v11, v30               // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v1, v19, v30                // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x14, 8, e16, m1, tu, mu        // ............*...............................
        vsrl.vi v1, v1, 4, v0.t                 // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v28, v28, 4, v0.t               // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v29, v1, x5                     // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v19, v28, x5                    // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v13, v29, x6                  // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v4, v19, x6                   // ...............................*............ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x9, v13                         // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v1, v29, v13               // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x4, v4                          // ....................................*....... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v27, v19, v4               // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        add x14, x4, x4                         // ........................................*...
        add x4, x9, x9                          // ........................................*...
        vse16.v v1, (x10)                       // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x15, x10, x4                        // .........................................*..
        add x10, x15, x14                       // ..........................................*.
        vse16.v v27, (x15)                      // ...........................................* // @slothy:lmul=1 // @slothy:sew=16
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        start_x1:
                                               ...
                                               // |------------------------|--------
        vsetivli x9, 16, e8, m1, tu, mu        // *.................................
        vle8.v v28, (x11)                      // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                      // ....*.............................
        vrgather.vv v1, v28, v30               // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu        // ...........*......................
        vsrl.vi v1, v1, 4, v0.t                // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v11, v1, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v19, v11, x6                 // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x16, v19                       // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v1, v11, v19              // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x4, x16, x16                       // ...............................*..
        vse16.v v1, (x10)                      // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x4                       // .................................*
