...
rej_uniform_rvv_vlen128_loop_x4:
        ...
        addi x11, x11, 12*4                    // ....*......................................................................
        vle8.v v27, (x21)                      // ......*.................................................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v22, (x9)                       // ........*.................................................................. // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v15, (x23)                      // ..........*................................................................ // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v9, v4, v30                // ............*.............................................................. // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v28, v27, v30              // ................*.......................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v20, v22, v30              // ....................*...................................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v4, v15, v30               // ........................*.................................................. // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu        // ........................*..................................................
        vsrl.vi v28, v28, 4, v0.t              // ................................*.......................................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v22, v9, 4, v0.t               // ..................................*........................................ // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v17, v28, x5                   // ....................................*...................................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v13, v22, x5                   // ......................................*.................................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v1, v17, x6                  // ........................................*.................................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v11, v13, x6                 // ..........................................*................................ // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v22, v20, 4, v0.t              // ............................................*.............................. // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v15, v4, 4, v0.t               // ..............................................*............................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x9, v11                        // ...............................................*........................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v27, v22, x5                   // ................................................*.......................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v16, v15, x5                   // ..................................................*........................ // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x21, v1                        // ...................................................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v28, v27, x6                 // ....................................................*...................... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v9, v17, v1               // ......................................................*.................... // @slothy:lmul=1 // @slothy:sew=16
        add x9, x9, x9                         // .......................................................*...................
        add x9, x10, x9                        // ........................................................*..................
        vmsltu.vx v4, v16, x6                  // .........................................................*................. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x23, v28                       // ..........................................................*................ // @slothy:lmul=1 // @slothy:sew=16
        add x25, x21, x21                      // ...........................................................*...............
        vse16.v v9, (x9)                       // ...........................................................*............... // @slothy:lmul=1 // @slothy:sew=16
        add x25, x9, x25                       // ............................................................*..............
        vcompress.vm v9, v13, v11              // .............................................................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x20, v4                        // ..............................................................*............ // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v16, v4              // ................................................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vse16.v v9, (x10)                      // ...................................................................*....... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v22, v27, v28             // .....................................................................*..... // @slothy:lmul=1 // @slothy:sew=16
        add x9, x23, x23                       // ......................................................................*....
        add x9, x25, x9                        // .......................................................................*...
        vse16.v v15, (x9)                      // ........................................................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x7, x20, x20                       // ........................................................................*..
        vse16.v v22, (x25)                     // ..........................................................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x9, x7                        // ..........................................................................*
...
rej_uniform_rvv_vlen128_loop_x2:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x2
        start_x2:
                                                ...
                                                // 0                        25
                                                // |------------------------|------------------
        vsetivli x29, 16, e8, m1, tu, mu        // *...........................................
        addi x7, x11, 12                        // *...........................................
        vle8.v v24, (x7)                        // ....*....................................... // @slothy:lmul=1 // @slothy:sew=8
        vle8.v v6, (x11)                        // ......*..................................... // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12*2                     // ......*.....................................
        vrgather.vv v28, v24, v30               // ........*................................... // @slothy:lmul=1 // @slothy:sew=8
        vrgather.vv v21, v6, v30                // ............*............................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x7, 8, e16, m1, tu, mu         // ............*...............................
        vsrl.vi v23, v21, 4, v0.t               // ....................*....................... // @slothy:lmul=1 // @slothy:sew=16
        vsrl.vi v24, v28, 4, v0.t               // ......................*..................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v28, v23, x5                    // ........................*................... // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v13, v24, x5                    // ..........................*................. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v11, v28, x6                  // ............................*............... // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v26, v13, x6                  // ..............................*............. // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x9, v11                         // ................................*........... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v2, v28, v11               // .................................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x23, v26                        // ....................................*....... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v14, v13, v26              // ......................................*..... // @slothy:lmul=1 // @slothy:sew=16
        add x9, x9, x9                          // ........................................*...
        vse16.v v2, (x10)                       // .........................................*.. // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x9                        // .........................................*..
        add x7, x23, x23                        // ..........................................*.
...
rej_uniform_rvv_vlen128_loop_x1:
    ...
    bgtu t3, t5, rej_uniform_rvv_vlen128_loopend_x1
        ...
        vle8.v v4, (x11)                       // ....*............................. // @slothy:lmul=1 // @slothy:sew=8
        addi x11, x11, 12                      // ....*.............................
        vrgather.vv v15, v4, v30               // .......*.......................... // @slothy:lmul=1 // @slothy:sew=8
        vsetivli x9, 8, e16, m1, tu, mu        // ...........*......................
        vsrl.vi v15, v15, 4, v0.t              // ...............*.................. // @slothy:lmul=1 // @slothy:sew=16
        vand.vx v4, v15, x5                    // ...................*.............. // @slothy:lmul=1 // @slothy:sew=16
        vmsltu.vx v22, v4, x6                  // .......................*.......... // @slothy:lmul=1 // @slothy:sew=16
        vcpop.m x9, v22                        // ...........................*...... // @slothy:lmul=1 // @slothy:sew=16
        vcompress.vm v15, v4, v22              // .............................*.... // @slothy:lmul=1 // @slothy:sew=16
        add x9, x9, x9                         // ...............................*..
        vse16.v v15, (x10)                     // .................................* // @slothy:lmul=1 // @slothy:sew=16
        add x10, x10, x9                       // .................................*
