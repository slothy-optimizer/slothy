...
pqcrystals_dilithium_ntt_opt_m7:
  ...
  // TODO: CURRENTLY MANUALLY ADJUSTED
  add.w temp_l, ptr_p, #31*strincr // 31 iterations (-1 for preamble+postamble)
  vmov s9, temp_l
                                           // Instructions:    59
                                           // Expected cycles: 31
                                           // Expected IPC:    1.90
        ...
        smlal r11, r6, r10, r3             // ......*........................
        ldr.w r4, [r0, #2*512/4]           // ......*........................
        smull r11, r10, r14, r9            // .......*.......................
        ldr.w r14, [r0, #3*512/4]          // .......*.......................
        add r14, r14, r6                   // ........*......................
        smlal r1, r5, r12, r3              // ........*......................
        ...
        smlal r10, r11, r9, r3             // .......................*.......
        vmov r10, s3                       // .......................*.......
        sub.w r9, r1, r7, lsl #1           // ........................*......
        smull r7, r14, r14, r10            // ........................*......
        add r1, r1, r11                    // .........................*.....
        str.w r1, [r0, #4*512/4]           // .........................*.....
        ...
        smull r12, r7, r6, r10             // ..............................*
                                           ...
                                           // 0                        25
                                           // |------------------------|-----
        // ldr.w r14, [r0, #7*512/4]       // *..............................
        // ldr.w r10, [r0, #4*512/4]       // .....*.........................
        // vmov r1, s2                     // .*.............................
        // smull r14, r4, r14, r1          // ..*............................
        // mul r12, r14, r2                // ....*..........................
        // smull r10, r7, r10, r1          // .............*.................
        ...
        // mul r4, r1, r2                  // ............*..................
        // ldr.w r11, [r0, #1*512/4]       // ............*..................
        // add r11, r11, r10               // .............*.................
        // smull r9, r12, r9, r12          // ................*..............
        // smlal r1, r6, r4, r3            // ..............*................
        // add r4, r8, r7                  // ...................*...........
        // sub.w r1, r11, r10, lsl #1      // ...............*...............
        // mul r8, r9, r2                  // ..................*............
        // add r1, r1, r6                  // ................*..............
        // vmov r10, s7                    // ..................*............
...
layer123_loop:
        ...
        mul r5, r12, r2                    // .*........................................
        sub.w r6, r10, r8, lsl #1          // .*........................................
        smull r1, r9, r14, r1              // ..*.......................................
        str.w r10, [r0, #6*512/4]          // ..*.......................................
        vmov r8, s5                        // ...*......................................
        smlal r12, r7, r5, r3              // ...*......................................
        ...
        mul r4, r1, r2                     // .....*....................................
        mul r12, r8, r2                    // ......*...................................
        ldr.w r10, [r0, #4*512/4]          // ......e...................................
        smlal r1, r9, r4, r3               // .......*..................................
        vmov r1, s2                        // .......e..................................
        smull r14, r4, r14, r1             // ........e.................................
        str.w r6, [r0, #7*512/4]           // ........*.................................
        smlal r8, r5, r12, r3              // .........*................................
        ...
        smull r10, r7, r10, r1             // ...........e..............................
        str.w r6, [r0, #2*512/4]           // ............*.............................
        smlal r14, r4, r12, r3             // ............e.............................
        mul r12, r10, r2                   // .............e............................
        ldr.w r8, [r0]                     // .............e............................
        str.w r9, [r0, #3*512/4]           // ..............*...........................
        ldr.w r6, [r0, #5*512/4]           // ..............e...........................
        ldr.w r14, [r0, #6*512/4]          // ...............e..........................
        smlal r10, r7, r12, r3             // ...............e..........................
        add r11, r11, r5                   // ................*.........................
        smull r12, r10, r6, r1             // ................e.........................
        str r11, [r0], #4                  // .................*........................ // @slothy:core
        smull r6, r9, r14, r1              // .................e........................
        mul r14, r12, r2                   // ..................e.......................
        ldr.w r1, [r0, #3*512/4]           // ..................e.......................
        sub.w r11, r11, r5, lsl #1         // ...................*......................
        mul r5, r6, r2                     // ...................e......................
        smlal r12, r10, r14, r3            // ....................e.....................
        add r14, r1, r4                    // ....................e.....................
        smlal r6, r9, r5, r3               // .....................e....................
        vmov r12, s4                       // .....................e....................
        ldr.w r6, [r0, #2*512/4]           // ......................e...................
        sub.w r4, r14, r4, lsl #1          // ......................e...................
        add r5, r6, r9                     // .......................e..................
        smull r1, r6, r4, r12              // .......................e..................
        str.w r11, [r0, #1*512/4]          // ........................*.................
        sub.w r9, r5, r9, lsl #1           // ........................e.................
        mul r4, r1, r2                     // .........................e................
        ldr.w r11, [r0, #1*512/4]          // .........................e................
        add r11, r11, r10                  // ..........................e...............
        smull r9, r12, r9, r12             // ..........................e...............
        smlal r1, r6, r4, r3               // ...........................e..............
        add r4, r8, r7                     // ...........................e..............
        sub.w r1, r11, r10, lsl #1         // ............................e.............
        mul r8, r9, r2                     // ............................e.............
        add r1, r1, r6                     // .............................e............
        vmov r10, s7                       // .............................e............
        sub.w r6, r1, r6, lsl #1           // ..............................e...........
        smull r10, r1, r1, r10             // ..............................e...........
        smlal r9, r12, r8, r3              // ...............................e..........
        sub.w r7, r4, r7, lsl #1           // ...............................e..........
        mul r9, r10, r2                    // ................................e.........
        vmov r8, s8                        // ................................e.........
        smull r6, r8, r6, r8               // .................................e........
        add r7, r7, r12                    // .................................e........
        smlal r10, r1, r9, r3              // ..................................e.......
        vmov r10, s3                       // ..................................e.......
        sub.w r9, r7, r12, lsl #1          // ...................................e......
        smull r12, r14, r14, r10           // ...................................e......
        add r7, r7, r1                     // ....................................e.....
        str.w r7, [r0, #4*512/4]           // ....................................e.....
        sub.w r7, r7, r1, lsl #1           // .....................................e....
        mul r1, r12, r2                    // .....................................e....
        str.w r7, [r0, #5*512/4]           // ......................................e...
        mul r7, r6, r2                     // ......................................e...
        smlal r12, r14, r1, r3             // .......................................e..
        vmov r1, s6                        // .......................................e..
        smlal r6, r8, r7, r3               // ........................................e.
        add r11, r11, r14                  // .........................................e
        smull r12, r7, r5, r10             // .........................................e
        ...
        smull r6, r9, r11, r6              // .*............................
        smlal r12, r7, r10, r3             // ..*...........................
        sub.w r12, r11, r14, lsl #1        // ..*...........................
        mul r14, r6, r2                    // ...*..........................
        str.w r5, [r0, #6*512/4]           // ...*..........................
        sub.w r8, r5, r8, lsl #1           // ....*.........................
        smull r12, r10, r12, r1            // ....*.........................
        smlal r6, r9, r14, r3              // .....*........................
        str.w r8, [r0, #7*512/4]           // .....*........................
        add r6, r4, r7                     // ......*.......................
        mul r8, r12, r2                    // ......*.......................
        ...
        str.w r12, [r0, #1*512/4]          // .........*....................
        add r7, r7, r10                    // ..........*...................
        sub.w r12, r7, r10, lsl #1         // ...........*..................
        str.w r7, [r0, #2*512/4]           // ...........*..................
        str.w r12, [r0, #3*512/4]          // .............*................
  ...
  1:
    // TODO: CURRENTLY MANUALLY ADJUSTED
    add.w temp_l, ptr_p, #3*strincr // 3 iterations (1 for preamble+postamble)
    vmov s10, temp_l
    vmov ptr_zeta, s0
    vldm ptr_zeta!, {s2-s8}
    vmov s0, ptr_zeta
...
layer456_loop:
        ...
        smlal r8, r1, r6, r3               // ................*.............................
        ldr.w r8, [r0]                     // ................*.............................
        smull r14, r6, r14, r11            // .................*............................
        smlal r10, r5, r9, r3              // ..................*...........................
        ldr.w r9, [r0, #1*64/4]            // ..................*...........................
        mul r11, r14, r2                   // ...................*..........................
        add r10, r9, r12                   // ...................*..........................
        sub.w r9, r10, r12, lsl #1         // ....................*.........................
        add r8, r8, r7                     // ....................*.........................
        ...
        str.w r10, [r0, #3*64/4]           // .........................................*....
        add r1, r7, r4                     // .........................................*....
        sub.w r12, r1, r4, lsl #1          // ..........................................*...
        ldr.w r4, [r0, #7*64/4]            // ..........................................e...
        str.w r12, [r0, #1*64/4]           // ...........................................*..
        smull r9, r12, r8, r11             // ...........................................e..
        smull r14, r5, r4, r11             // ............................................e.
        mul r6, r9, r2                     // .............................................e
        ...
        ldr.w r8, [r0, #3*64/4]            // ...*......................................
        add r6, r8, r5                     // ....*.....................................
        smull r7, r11, r10, r11            // ....*.....................................
        mul r10, r1, r2                    // .....*....................................
        sub.w r5, r6, r5, lsl #1           // .....*....................................
        smull r8, r6, r6, r4               // ......*...................................
        ldr.w r9, [r0, #1*64/4]            // ......*...................................
        smlal r1, r14, r10, r3             // .......*..................................
        add r10, r9, r12                   // .......*..................................
        ...
        smlal r10, r8, r14, r3             // ............................*.............
        vmov r10, s7                       // ............................*.............
        smull r1, r12, r12, r10            // .............................*............
        vmov r10, s8                       // .............................*............
        add r14, r7, r8                    // ..............................*...........
        smlal r4, r9, r6, r3               // ..............................*...........
        mul r6, r1, r2                     // ...............................*..........
        str r14, [r0], #4                  // ...............................*.......... // @slothy:core
        sub.w r4, r14, r8, lsl #1          // ................................*.........
        smull r14, r10, r5, r10            // ................................*.........
        smlal r1, r12, r6, r3              // .................................*........
        str.w r4, [r0, #1*64/4]            // .................................*........
        add r7, r11, r9                    // ..................................*.......
        mul r11, r14, r2                   // ..................................*.......
        add r1, r7, r12                    // ...................................*......
        str.w r1, [r0, #4*64/4]            // ...................................*......
        sub.w r6, r1, r12, lsl #1          // ....................................*.....
        smlal r14, r10, r11, r3            // ....................................*.....
        sub.w r14, r7, r9, lsl #1          // .....................................*....
        str.w r6, [r0, #5*64/4]            // .....................................*....
        add r6, r14, r10                   // ......................................*...
        sub.w r4, r6, r10, lsl #1          // .......................................*..
        str.w r6, [r0, #6*64/4]            // .......................................*..
        str.w r4, [r0, #7*64/4]            // .........................................*
...
1:
        ...
        add r5, r5, r12                   // ......*.......................
        smlal r8, r14, r10, r3            // .......*......................
        sub.w r12, r5, r12, lsl #1        // .......*......................
        mul r8, r7, r2                    // ........*.....................
        add r10, r5, r14                  // .........*....................
        str r10, [r0], #16                // .........*.................... // @slothy:core
        smlal r7, r6, r8, r3              // ..........*...................
        sub.w r7, r10, r14, lsl #1        // ..........*...................
        str.w r7, [r0, #4]                // ...........*..................
        add r7, r12, r6                   // ............*.................
        sub.w r12, r7, r6, lsl #1         // .............*................
        str.w r7, [r0, #8]                // .............*................
        str.w r12, [r0, #12]              // ...............*..............
