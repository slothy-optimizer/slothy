...
layer123_loop:
        ...
        add r5, r5, r4                    // .....*........................................
        smlal r1, r8, r10, r3             // .....*........................................
        sub.w r10, r5, r4, lsl #1         // ......*.......................................
        mul r4, r6, r2                    // ......*.......................................
        ldr.w r1, [r0, #128]              // .......*......................................
        smull r7, r9, r7, r9              // .......*......................................
        add r1, r1, r14                   // ........*.....................................
        smlal r6, r12, r4, r3             // ........*.....................................
        sub.w r6, r1, r14, lsl #1         // .........*....................................
        mul r4, r7, r2                    // .........*....................................
        add r6, r6, r12                   // ..........*...................................
        vmov r14, s8                      // ..........*...................................
        sub.w r12, r6, r12, lsl #1        // ...........*..................................
        smlal r7, r9, r4, r3              // ...........*..................................
        add r4, r1, r11                   // ............*.................................
        smull r12, r1, r12, r14           // ............*.................................
        add r14, r10, r9                  // .............*................................
        vmov r10, s5                      // .............*................................
        sub.w r7, r14, r9, lsl #1         // ..............*...............................
        mul r9, r12, r2                   // ..............*...............................
        ...
        add r14, r14, r9                  // .........................*....................
        str.w r14, [r0, #512]             // .........................*....................
        sub.w r6, r14, r9, lsl #1         // ..........................*...................
        mul r14, r7, r2                   // ..........................*...................
        ldr.w r4, [r0, #900]              // ...........................e..................
        str.w r6, [r0, #640]              // ...........................*..................
        vmov r9, s2                       // ............................e.................
        smlal r7, r11, r14, r3            // ............................*.................
        smull r14, r12, r1, r9            // .............................e................
        add r1, r5, r10                   // ..............................*...............
        smull r4, r7, r4, r9              // ..............................e...............
        add r8, r8, r11                   // ...............................*..............
        mul r5, r14, r2                   // ...............................e..............
        ...
        smlal r14, r12, r5, r3            // .................................e............
        sub.w r10, r1, r10, lsl #1        // ..................................*...........
        smull r6, r14, r6, r9             // ..................................e...........
        vmov r11, s9                      // ...................................*..........
        mul r5, r4, r2                    // ...................................e..........
        str r1, [r0], #4                  // ....................................*......... // @slothy:core // @slothy:before=cmp
        ldr.w r1, [r0, #512]              // ....................................e.........
        cmp.w r0, r11                     // .....................................*........ // @slothy:id=cmp
        smlal r4, r7, r5, r3              // .....................................e........
        ldr.w r5, [r0, #384]              // ......................................e.......
        smull r11, r4, r1, r9             // ......................................e.......
        str.w r8, [r0, #380]              // .......................................*......
        ldr.w r1, [r0, #256]              // .......................................e......
        add r8, r1, r12                   // ........................................e.....
        mul r1, r11, r2                   // ........................................e.....
        add r5, r5, r7                    // .........................................e....
        mul r9, r6, r2                    // .........................................e....
        smlal r11, r4, r1, r3             // ..........................................e...
        vmov r1, s3                       // ...........................................e..
        smlal r6, r14, r9, r3             // ...........................................e..
        sub.w r6, r5, r7, lsl #1          // ............................................e.
        smull r5, r11, r5, r1             // ............................................e.
        str.w r10, [r0, #124]             // .............................................*
        ...
        add r9, r7, r14                    // ...*...........................
        mul r5, r1, r2                     // ...*...........................
        sub.w r7, r9, r14, lsl #1          // ....*..........................
        smull r12, r14, r12, r10           // ....*..........................
        add r9, r9, r11                    // .....*.........................
        smlal r1, r8, r5, r3               // .....*.........................
        ldr.w r1, [r0]                     // ......*........................
        mul r5, r12, r2                    // ......*........................
        ...
        add r12, r4, r14                   // .......................*.......
        smlal r10, r6, r1, r3              // .......................*.......
        sub.w r10, r12, r14, lsl #1        // ........................*......
        mul r5, r11, r2                    // ........................*......
        add r4, r12, r6                    // .........................*.....
        str.w r4, [r0, #508]               // .........................*.....
        sub.w r12, r4, r6, lsl #1          // ..........................*....
        smlal r11, r9, r5, r3              // ..........................*....
...
layer456_loop:
        ...
        smlal r1, r5, r11, r3              // .*.............................................
        mul r1, r6, r2                     // ..*............................................
        smull r11, r10, r10, r8            // ...*...........................................
        sub.w r7, r12, r7, lsl #1          // ....*..........................................
        smlal r6, r14, r1, r3              // ....*..........................................
        smull r7, r6, r7, r8               // .....*.........................................
        ldr.w r8, [r0, #64]                // ......*........................................
        mul r1, r11, r2                    // ......*........................................
        ...
        add r9, r9, r8                     // ..........................*....................
        str.w r9, [r0, #32]                // ..........................*....................
        sub.w r9, r9, r8, lsl #1           // ...........................*...................
        smlal r14, r5, r11, r3             // ...........................*...................
        str.w r9, [r0, #48]                // ............................*..................
        vmov r11, s5                       // ............................*..................
        add r7, r10, r5                    // .............................*.................
        smull r10, r8, r12, r11            // .............................*.................
        ldr.w r6, [r0, #100]               // ..............................e................
        str.w r7, [r0, #96]                // ..............................*................
        vmov r4, s2                        // ...............................e...............
        mul r9, r10, r2                    // ...............................*...............
        sub.w r12, r7, r5, lsl #1          // ................................*..............
        smull r14, r6, r6, r4              // ................................e..............
        ldr.w r11, [r0, #116]              // .................................e.............
        smlal r10, r8, r9, r3              // .................................*.............
        ldr.w r9, [r0, #36]                // ..................................e............
        mul r10, r14, r2                   // ..................................e............
        add r5, r1, r8                     // ...................................*...........
        smull r1, r7, r11, r4              // ...................................e...........
        smlal r14, r6, r10, r3             // ....................................e..........
        sub.w r8, r5, r8, lsl #1           // .....................................*.........
        mul r14, r1, r2                    // .....................................e.........
        str r5, [r0], #4                   // ......................................*........ // @slothy:core // @slothy:before=cmp
        add r10, r9, r6                    // ......................................e........
        vmov r5, s3                        // .......................................e.......
        smlal r1, r7, r14, r3              // .......................................e.......
        ldr.w r14, [r0, #48]               // ........................................e......
        smull r11, r9, r10, r5             // ........................................e......
        str.w r12, [r0, #108]              // .........................................*.....
        sub.w r10, r10, r6, lsl #1         // .........................................e.....
        add r12, r14, r7                   // ..........................................e....
        mul r6, r11, r2                    // ..........................................e....
        vmov r14, s10                      // ...........................................*...
        smull r1, r5, r12, r5              // ...........................................e...
        ...
        str.w r6, [r0, #112]               // ..............................*...
        add r14, r14, r4                   // ..............................*...
        str r14, [r0], #4                  // ...............................*.. // @slothy:core // @slothy:before=cmp
        cmp.w r0, r9                       // ...............................*.. // @slothy:id=cmp
        str.w r5, [r0, #60]                // ................................*.
        sub.w r11, r14, r4, lsl #1         // ................................*.
        str.w r11, [r0, #12]               // .................................*
...
layer78_loop:
        ...
        mul r5, r11, r2                    // ...*..........................
        ldr r12, [r1, #-4]                 // ....*.........................
        smull r14, r10, r8, r10            // ....*.........................
        sub.w r8, r8, r7, lsl #1           // .....*........................
        smlal r11, r6, r5, r3              // .....*........................
        ldr.w r7, [r0, #28]                // ......e.......................
        mul r5, r14, r2                    // ......*.......................
        add r11, r9, r6                    // .......*......................
        smull r12, r9, r8, r12             // .......*......................
        sub.w r6, r11, r6, lsl #1          // ........*.....................
        smlal r14, r10, r5, r3             // ........*.....................
        ldr r5, [r1], #12                  // .........e....................
        mul r8, r12, r2                    // .........*....................
        add r11, r11, r10                  // ..........*...................
        str r11, [r0], #16                 // ..........*................... // @slothy:core // @slothy:before=cmp
        sub.w r11, r11, r10, lsl #1        // ...........*..................
        smlal r12, r9, r8, r3              // ...........*..................
        ldr.w r8, [r0, #8]                 // ............e.................
        smull r14, r7, r7, r5              // ............e.................
        add r6, r6, r9                     // .............*................
        str r6, [r0, #-8]                  // .............*................
        str r11, [r0, #-12]                // ..............*...............
        ...
        add r9, r9, r10                   // ........*.....................
        smlal r6, r14, r11, r3            // ........*.....................
        sub.w r6, r9, r10, lsl #1         // .........*....................
        mul r10, r7, r2                   // .........*....................
        add r9, r9, r14                   // ..........*...................
        str r9, [r0], #16                 // ..........*................... // @slothy:core // @slothy:before=cmp
        cmp.w r0, r4                      // ...........*.................. // @slothy:id=cmp
        smlal r7, r12, r10, r3            // ...........*..................
