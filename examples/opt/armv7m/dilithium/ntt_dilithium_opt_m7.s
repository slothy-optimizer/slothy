...
pqcrystals_dilithium_ntt_opt_m7:
  ...
  layer123_loop:
    ...
    str pol0, [ptr_p], #strincr // @slothy:core // @slothy:before=cmp
    vmov temp_l, s9
  ...
  1:
    ...
    layer456_loop:
      ...
      str pol0, [ptr_p], #4 // @slothy:core // @slothy:before=cmp
      vmov temp_l, s10
      cmp.w ptr_p, temp_l // @slothy:id=cmp
      bne layer456_loop
...
layer78_loop:
        ...
        ldr.w r14, [r0, #24]               // ............e.................
        str.w r8, [r0, #4]                 // ............*.................
        str r11, [r0], #16                 // .............*................ // @slothy:core // @slothy:before=cmp
        add r12, r12, r10                  // .............*................
        str r12, [r0, #-8]                 // ..............*...............
        cmp.w r0, r4                       // ..............*............... // @slothy:id=cmp
        sub.w r12, r12, r10, lsl #1        // ...............*..............
        mul r10, r5, r2                    // ...............e..............
        str r12, [r0, #-4]                 // ................*.............
        ...
        mul r12, r5, r2                   // .........*....................
        add r7, r10, r14                  // ..........*...................
        str r7, [r0], #16                 // ..........*................... // @slothy:core // @slothy:before=cmp
        cmp.w r0, r4                      // ...........*.................. // @slothy:id=cmp
        smlal r5, r9, r12, r3             // ...........*..................
        sub.w r12, r7, r14, lsl #1        // ............*.................
        str r12, [r0, #-12]               // ............*.................
        add r12, r8, r9                   // .............*................
        str r12, [r0, #-8]                // .............*................
