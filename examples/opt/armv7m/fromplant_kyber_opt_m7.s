...
1:
        ...
        pkhtb r14, r3, r7, asr #16         // ....................*...........................
        smlabt r7, r1, r11, r12            // ....................*...........................
        str r14, [r0, #28]                 // .....................*..........................
        pkhtb r1, r4, r6, asr #16          // ......................*.........................
        ldr r6, [r0, #0]                   // ......................*.........................
        str r1, [r0, #20]                  // .......................*........................
        smulwt r4, r10, r6                 // .........................*......................
        smulwb r3, r10, r6                 // ..........................*.....................
        ...
        smlabt r5, r7, r11, r12           // .........................*.....................
        pkhtb r6, r2, r8, asr #16         // ..........................*....................
        str r4, [r0, #28]                 // ..........................*....................
        ldr r4, [r0, #16]                 // ...........................*...................
        str r6, [r0], #32                 // ............................*..................
        pkhtb r2, r14, r5, asr #16        // .............................*.................
        str r2, [r0, #-28]                // ..............................*................
        ldr r2, [r0, #-8]                 // ..............................*................
        smulwb r7, r10, r2                // ................................*..............
        smulwb r8, r10, r4                // .................................*.............
        ...
        smlabt r4, r4, r11, r12           // .......................................*.......
        smlabt r2, r2, r11, r12           // ........................................*......
        pkhtb r14, r4, r5, asr #16        // .........................................*.....
        str r14, [r0, #-16]               // .........................................*.....
        pkhtb r6, r2, r3, asr #16         // ...........................................*...
        smlabt r5, r7, r11, r12           // ...........................................*...
        str r6, [r0, #-20]                // ............................................*..
        pkhtb r6, r8, r5, asr #16         // ..............................................*
        str r6, [r0, #-8]                 // ..............................................*
