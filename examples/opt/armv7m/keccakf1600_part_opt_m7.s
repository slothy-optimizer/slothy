...
.rept 10
                                           ...
                                           // 0                        25
                                           // |------------------------|----
        ldr.w r1, [r0, #28]                // *............................. // @slothy:reads=['r0\\()Abo1']
        ldr.w r2, [r0, #68]                // .*............................ // @slothy:reads=['r0\\()Ago1']
        ldr.w r5, [r0, #64]                // .*............................ // @slothy:reads=['r0\\()Ago0']
        eors.w r2, r1, r2                  // ..*...........................
        ldr.w r4, [r0, #108]               // ..*........................... // @slothy:reads=['r0\\()Ako1']
        eors.w r12, r2, r4                 // ...*..........................
        ldr.w r2, [r0, #148]               // ...*.......................... // @slothy:reads=['r0\\()Amo1']
        ldr.w r4, [r0, #188]               // ....*......................... // @slothy:reads=['r0\\()Aso1']
        eors.w r12, r12, r2                // ....*.........................
        ldr.w r2, [r0, #24]                // .....*........................ // @slothy:reads=['r0\\()Abo0']
        eors.w r12, r12, r4                // .....*........................
        eors.w r4, r2, r5                  // ......*.......................
        ldr.w r5, [r0, #104]               // ......*....................... // @slothy:reads=['r0\\()Ako0']
        eors.w r2, r4, r5                  // .......*......................
        ldr.w r5, [r0, #144]               // .......*...................... // @slothy:reads=['r0\\()Amo0']
        eors.w r2, r2, r5                  // ........*.....................
        ldr.w r5, [r0, #184]               // ........*..................... // @slothy:reads=['r0\\()Aso0']
        eor.w r4, r14, r12, ror #31        // .........*....................
        eors.w r5, r2, r5                  // .........*....................
        str.w r4, [sp, #16]                // ..........*................... // @slothy:writes=['sp\\()\\mDi0']
        eors.w r4, r7, r5                  // ..........*...................
        eor.w r2, r5, r6, ror #31          // ...........*..................
        ...
        ldr.w r5, [r0, #72]                // ..............*............... // @slothy:reads=['r0\\()Agu0']
        eors.w r1, r8                      // ..............*...............
        eors.w r7, r4                      // ...............*..............
        eors.w r6, r11                     // ...............*..............
        eors.w r3, r9                      // ................*.............
        ...
        eors.w r4, r2, r3                  // ....................*.........
        bic.w r2, r6, r1                   // ....................*.........
        str.w r4, [r0, #84]                // .....................*........ // @slothy:writes=['r0\\()Aka1']
        eors.w r2, r2, r5                  // .....................*........
        str.w r2, [r0, #132]               // ......................*....... // @slothy:writes=['r0\\()Ame1']
        bic.w r2, r7, r6                   // ......................*.......
        eors.w r4, r2, r1                  // .......................*......
        bic.w r2, r3, r7                   // .......................*......
        ...
        eors.w r4, r2, r6                  // ........................*.....
        bic.w r5, r5, r3                   // .........................*....
        str.w r4, [r0, #24]                // .........................*.... // @slothy:writes=['r0\\()Abo0']
        eors.w r5, r5, r7                  // ..........................*...
        str.w r5, [r0, #72]                // ..........................*... // @slothy:writes=['r0\\()Agu0']
