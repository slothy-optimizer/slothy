...
layer123_loop:
        ...
        ldr.w r8, [r0, #4]                // ..........*...................
        mul r4, r14, r2                   // ..........*...................
        sub.w r1, r5, r12, lsl #1         // ...........*..................
        vmov r12, s4                      // ...........*..................
        sub.w r9, r10, r9, lsl #1         // ............*.................
        smlal r14, r7, r4, r3             // ............*.................
        add r11, r8                       // .............*................
        smull r4, r9, r9, r12             // .............*................
        sub.w r14, r11, r8, lsl #1        // ..............*...............
        add r11, r10                      // ..............*...............
        sub.w r8, r11, r10, lsl #1        // ...............*..............
        mul r10, r4, r2                   // ...............*..............
        add r11, r5                       // ................*.............
        smull r1, r12, r1, r12            // ................*.............
        ...
        vmov r10, s9                      // ..................*...........
        mul r4, r1, r2                    // ..................*...........
        str.w r11, [r0], #32              // ...................*.......... // @slothy:before=cmp
        add r14, r9                       // ...................*..........
        sub.w r11, r14, r9, lsl #1        // ....................*.........
        add r14, r6                       // ....................*.........
        sub.w r9, r14, r6, lsl #1         // .....................*........
        smlal r1, r12, r4, r3             // .....................*........
        add r11, r7                       // ......................*.......
        str r9, [r0, #-12]                // ......................*.......
        add r8, r12                       // .......................*......
        str r5, [r0, #-16]                // .......................*......
        sub.w r4, r8, r12, lsl #1         // ........................*.....
        str r4, [r0, #-8]                 // ........................*.....
        sub.w r7, r11, r7, lsl #1         // .........................*....
        str r7, [r0, #-4]                 // .........................*....
        cmp.w r0, r10                     // ..........................*... // @slothy:id=cmp
        str r14, [r0, #-28]               // ..........................*...
        str r8, [r0, #-24]                // ...........................*..
        ldr.w r7, [r0, #16]               // ...........................e..
        str r11, [r0, #-20]               // ............................*.
        ...
        add r1, r5                        // .......................*......
        str r10, [r0, #-8]                // .......................*......
        sub.w r9, r1, r5, lsl #1          // ........................*.....
        add r1, r6                        // ........................*.....
        add r9, r12                       // .........................*....
        str r9, [r0, #-20]                // .........................*....
        sub.w r7, r1, r6, lsl #1          // ..........................*...
        str r1, [r0, #-28]                // ..........................*...
        str r7, [r0, #-12]                // ...........................*..
        sub.w r14, r9, r12, lsl #1        // ...........................*..
        str r14, [r0, #-4]                // ............................*.
...
layer456_first_loop:
        ...
        ldr.w r7, [r0, #224]              // ...*..........................
        add r11, r7                       // ....*.........................
        sub.w r14, r1, r5, lsl #1         // ....*.........................
        add.w r1, r1, r11                 // .....*........................
        smull r4, r6, r14, r8             // .....*........................
        sub.w r5, r11, r7, lsl #1         // ......*.......................
        smull r14, r7, r14, r12           // ......*.......................
        sub.w r10, r1, r11, lsl #1        // .......*......................
        smlal r4, r6, r5, r12             // .......*......................
        ldr r12, [r0, #96]                // ........*.....................
        smlal r14, r7, r5, r8             // ........*.....................
        ldr r9, [r0, #64]                 // .........*....................
        ...
        vmov r12, s4                      // .............*................
        add r11, r8                       // ..............*...............
        smull r14, r5, r14, r12           // ..............*...............
        sub.w r4, r11, r8, lsl #1         // ...............*..............
        add r11, r9                       // ...............*..............
        sub.w r8, r11, r9, lsl #1         // ................*.............
        mul r9, r14, r2                   // ................*.............
        add r11, r1                       // .................*............
        str r11, [r0]                     // .................*............
        smlal r14, r5, r9, r3             // ..................*...........
        sub.w r9, r11, r1, lsl #1         // ...................*..........
        smull r12, r10, r10, r12          // ...................*..........
        str.w r9, [r0, #128]              // ....................*.........
        add r4, r5                        // ....................*.........
        ...
        add r4, r6                        // ......................*.......
        str r4, [r0, #32]                 // ......................*.......
        sub.w r14, r4, r6, lsl #1         // .......................*......
        str.w r14, [r0, #160]             // .......................*......
        add r9, r7                        // ........................*.....
        smlal r12, r10, r5, r3            // ........................*.....
        sub.w r4, r9, r7, lsl #1          // .........................*....
        str.w r4, [r0, #224]              // .........................*....
        add r8, r10                       // ..........................*...
        str r8, [r0, #64]                 // ..........................*...
...
layer456_loop:
        ...
        add r6, r11                        // ......................................*........
        smlal r5, r9, r8, r3               // ......................................*........
        sub.w r5, r6, r11, lsl #1          // .......................................*.......
        mul r14, r4, r2                    // .......................................*.......
        add r7, r9                         // ........................................*......
        str r7, [r0, #96]                  // ........................................*......
        sub.w r12, r7, r9, lsl #1          // .........................................*.....
        smlal r4, r1, r14, r3              // .........................................*.....
        str.w r12, [r0, #224]              // ..........................................*....
        add r10, r1                        // ...........................................*...
        str r10, [r0, #64]                 // ...........................................*...
        sub.w r4, r10, r1, lsl #1          // ............................................*..
        str.w r4, [r0, #192]               // ............................................*..
        str r6, [r0, #32]                  // .............................................*.
        str.w r5, [r0, #160]               // ..............................................*
        add.w r0, r0, #256                 // ..............................................*
...
layer78_loop:
        ...
        add r6, r12                        // ............*.................
        mul r5, r8, r2                     // ............*.................
        smlal r4, r7, r11, r3              // .............e................
        ldr r11, [r1, #-24]                // ..............*...............
        smlal r8, r10, r5, r3              // ..............*...............
        ldr r8, [r1, #-16]                 // ...............*..............
        str r10, [r0], #4                  // ...............*.............. // @slothy:core // @slothy:before=cmp
        sub.w r10, r6, r12, lsl #1         // ................*.............
        smull r5, r6, r6, r11              // ................*.............
        ldr r12, [r1, #-20]                // .................*............
        smull r10, r8, r10, r8             // .................*............
        mul r4, r5, r2                     // ..................*...........
        vmov r11, s9                       // ...................*..........
        smull r12, r14, r14, r12           // ...................*..........
        ...
        // bne.w layer78_loop            // .......................~'..........................*
                                         ...
                                         // |------------------------|----
        add r4, r7                       // *.............................
        smull r11, r14, r10, r9          // *.............................
        sub.w r6, r4, r7, lsl #1         // .*............................
        smull r10, r7, r4, r5            // .*............................
        ldr r12, [r1, #-20]              // ..*...........................
        mul r5, r11, r2                  // ..*...........................
        ldr.w r9, [r0]                   // ...*..........................
        ...
        vmov r11, s9                     // ......................*.......
        smlal r14, r8, r12, r3           // ......................*.......
        str r8, [r0], #4                 // .......................*...... // @slothy:core // @slothy:before=cmp
        cmp.w r0, r11                    // .......................*...... // @slothy:id=cmp
        str.w r7, [r0, #764]             // ........................*.....
        str.w r5, [r0, #252]             // .........................*....
