...
1:
        ...
        vmov.w r4, s8                      // ...*..........................
        smull.w r5, r1, r8, r11            // ....*.........................
        add r6, r14                        // ....*.........................
        sub.w r9, r6, r14, lsl #1          // .....*........................
        smull.w r8, r7, r8, r4             // .....*........................
        smlal.w r5, r1, r9, r4             // ......*.......................
        ldr.w r12, [r0, #8]                // ......*.......................
        smlal.w r8, r7, r9, r11            // .......*......................
        ldr.w r11, [r0, #12]               // .......*......................
        add r12, r11                       // ........*.....................
        mul.w r9, r5, r2                   // ........*.....................
        mul.w r14, r8, r2                  // .........*....................
...
1:
        ...
        smull.w r4, r7, r4, r11           // .....*........................
        smlal.w r4, r7, r9, r8            // ......*.......................
        ldr.w r8, [r0], #128              // ......*.......................
        smlal.w r5, r1, r9, r11           // .......*......................
        ...
        add r6, r12                       // ....*.........................
        smull.w r5, r1, r4, r14           // ....*.........................
        smull.w r4, r7, r4, r11           // .....*........................
        sub.w r9, r6, r12, lsl #1         // .....*........................
        smlal.w r4, r7, r9, r14           // ......*.......................
        add.w r10, r6                     // ......*.......................
