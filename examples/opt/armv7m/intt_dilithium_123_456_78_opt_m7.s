...
layer123_loop:
        ...
        add r5, r6                         // ..*...........................
        add r9, r7                         // ...*..........................
        sub.w r8, r5, r6, lsl #1           // ...*..........................
        add.w r6, r5, r9                   // ....*.........................
        smull r5, r11, r8, r1              // ....*.........................
        sub.w r7, r9, r7, lsl #1           // .....*........................
        smull r14, r10, r8, r12            // .....*........................
        sub.w r8, r6, r9, lsl #1           // ......*.......................
        smlal r5, r11, r7, r12             // ......*.......................
        ldr.w r12, [r0, #8]                // .......*......................
        smlal r14, r10, r7, r1             // .......*......................
        ldr.w r9, [r0]                     // ........*.....................
        ...
        add.w r8, r5, r10                 // ....*.........................
        smull r9, r5, r11, r1             // ....*.........................
        sub.w r4, r10, r14, lsl #1        // .....*........................
        smull r14, r11, r11, r12          // .....*........................
        ldr.w r6, [r0, #8]                // ......*.......................
        smlal r9, r5, r4, r12             // ......*.......................
        ...
        str.w r8, [r0, #16]               // ...................*..........
        add r4, r14                       // ...................*..........
        sub.w r8, r4, r14, lsl #1         // ....................*.........
        smlal r10, r7, r1, r3             // ....................*.........
        add r4, r5                        // .....................*........
        str.w r4, [r0, #4]                // .....................*........
        add r6, r7                        // ......................*.......
        str.w r6, [r0, #8]                // ......................*.......
        sub.w r9, r4, r5, lsl #1          // .......................*......
        str.w r9, [r0, #20]               // .......................*......
        sub.w r9, r6, r7, lsl #1          // ........................*.....
        str.w r9, [r0, #24]               // ........................*.....
        add r8, r11                       // .........................*....
        str.w r8, [r0, #12]               // .........................*....
        sub.w r9, r8, r11, lsl #1         // ..........................*...
        str.w r9, [r0, #28]               // ..........................*...
        str.w r12, [r0], #32              // ...........................*..
...
layer456_first_loop:
        ...
        add.w r1, r9, r7                   // .....*........................
        smull r5, r11, r10, r4             // .....*........................
        sub.w r6, r7, r6, lsl #1           // ......*.......................
        smull r14, r10, r10, r12           // ......*.......................
        ldr.w r9, [r0], #128               // .......*......................
        smlal r14, r10, r6, r4             // .......*......................
        ...
        smull r7, r6, r7, r8               // .............*................
        add r9, r5                         // ..............*...............
        sub.w r14, r12, r4, lsl #1         // ...............*..............
        mul r4, r7, r2                     // ...............*..............
        sub.w r5, r9, r5, lsl #1           // ................*.............
        smull r14, r8, r14, r8             // ................*.............
        add r9, r12                        // .................*............
        smlal r7, r6, r4, r3               // .................*............
        sub.w r4, r9, r12, lsl #1          // ..................*...........
        mul r12, r14, r2                   // ..................*...........
        add r4, r6                         // ...................*..........
        str r4, [r0, #-64]                 // ...................*..........
        ...
        add r5, r8                         // ......................*.......
        str r9, [r0, #-128]                // ......................*.......
        sub.w r14, r5, r8, lsl #1          // .......................*......
        add r5, r11                        // .......................*......
        sub.w r7, r5, r11, lsl #1          // ........................*.....
        str.w r7, [r0, #32]                // ........................*.....
        str r5, [r0, #-96]                 // .........................*....
        add r14, r10                       // .........................*....
        str r14, [r0, #-32]                // ..........................*...
        sub.w r14, r14, r10, lsl #1        // ..........................*...
        str.w r14, [r0, #96]               // ...........................*..
        ...
        // smlal R7, R14, R1, R3              // ...........*.................'.
        // ldr.w R5, [R0], #128               // .......*.....................'.
        // ldr R6, [R0, #1*128/4-128]         // .............*...............'.
        // ldr R7, [R0, #2*128/4-128]         // .........*...................'.
        // ldr R8, [R0, #3*128/4-128]         // ..........*..................'.
        // add R5, R6                         // ..............*..............'.
        // add R7, R8                         // ...........*.................'.
        // sub.w R6, R5, R6, lsl #1           // ................*............'.
        // sub.w R8, R7, R8, lsl #1           // ...............*.............'.
        ...
        // sub.w R12, R7, R12, lsl #1         // ....................*........'.
        // sub.w R14, R8, R14, lsl #1         // ..........................*..'.
        // str R6, [R0, #1*128/4-128]         // .........................*...'.
        // str R7, [R0, #2*128/4-128]         // ...................*.........'.
        // str R8, [R0, #3*128/4-128]         // ..........................*..'.
...
layer456_loop:
        ...
        smull r7, r4, r11, r8             // .......................................*.........
        mul r5, r10, r2                   // ........................................*........
        sub.w r8, r9, r14, lsl #1         // .........................................*.......
        mul r11, r7, r2                   // .........................................*.......
        smlal r10, r6, r5, r3             // ..........................................*......
        sub.w r14, r12, r1, lsl #1        // ...........................................*.....
        smlal r7, r4, r11, r3             // ...........................................*.....
        add r9, r6                        // ............................................*....
        str r9, [r0, #-128]               // ............................................*....
        add r8, r4                        // .............................................*...
        ...
        // ldr R7, [R0, #2*128/4-128]         // .......*.........................................
        // ldr R8, [R0, #3*128/4-128]         // ..*..............................................
        // ldr.w R4, [R0, #4*128/4-128]       // .................*...............................
        // ldr.w R11, [R0, #5*128/4-128]      // .........*.......................................
        // ldr.w R12, [R0, #6*128/4-128]      // ....*............................................
        // ldr.w R14, [R0, #7*128/4-128]      // ...*.............................................
        // vmov R1, s2                        // *................................................
        // smull R9, R6, R6, R1               // .........*.......................................
        // mul R10, R9, R2                    // ...........*.....................................
        // smlal R9, R6, R10, R3              // .............*...................................
...
layer78_loop:
        ...
        smlal r11, r14, r4, r3           // .......*........................
        add r5, r10                      // ........*.......................
        sub.w r7, r5, r10, lsl #1        // .........*......................
        smull r12, r6, r5, r6            // .........*......................
        add r9, r14                      // ..........*.....................
        smull r5, r7, r7, r8             // ..........*.....................
        ldr.w r8, [r1, #12]              // ...........*....................
        mul r11, r12, r2                 // ...........*....................
        sub.w r4, r9, r14, lsl #1        // ............*...................
        mul r14, r5, r2                  // ............*...................
        ldr.w r10, [r1, #8]              // .............*..................
        smlal r12, r6, r11, r3           // .............*..................
        ldr.w r12, [r1, #4]              // ..............*.................
        ...
        add r4, r7                       // .................*..............
        smull r10, r6, r6, r10           // .................*..............
        sub.w r11, r4, r7, lsl #1        // ..................*.............
        smull r14, r7, r4, r12           // ..................*.............
        mul r4, r10, r2                  // ...................*............
        smull r12, r11, r11, r8          // ....................*...........
        ldr.w r8, [r1, #8]               // .....................e..........
        smlal r10, r6, r4, r3            // .....................*..........
        mul r10, r12, r2                 // ......................*.........
        mul r4, r14, r2                  // .......................*........
