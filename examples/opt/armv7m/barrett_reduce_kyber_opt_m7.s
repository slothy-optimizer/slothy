...
1:
        ...
        asr r7, r12, #26                  // ...................................*.....
        smulbb r1, r1, r11                // ...................................*.....
        pkhbt r12, r6, r4, lsl #16        // ....................................*....
        smulbb r4, r7, r11                // ....................................*....
        usub16 r7, r8, r12                // .....................................*...
        str r3, [r0, #12]                 // .....................................*...
        pkhbt r8, r4, r1, lsl #16         // ......................................*..
        str r2, [r0, #24]                 // ......................................*..
        subs.w r9, r9, #1                 // .......................................*.
        str r7, [r0, #20]                 // .......................................*.
        usub16 r5, r5, r8                 // ........................................*
        ...
        asr r2, r12, #26                   // ...........*............................
        smulbb r12, r3, r11                // ...........*............................
        pkhbt r3, r8, r6, lsl #16          // ............*...........................
        smulbb r6, r2, r11                 // ............*...........................
        usub16 r3, r5, r3                  // .............*..........................
        smultb r5, r7, r10                 // .............*..........................
        pkhbt r12, r6, r12, lsl #16        // ..............*.........................
        smultb r6, r1, r10                 // ..............*.........................
        usub16 r12, r4, r12                // ...............*........................
        smulbb r4, r7, r10                 // ...............*........................
        asr r8, r5, #26                    // ................*.......................
        ...
        usub16 r14, r14, r3                // ...................................*....
        smulbb r3, r12, r11                // ...................................*....
        pkhbt r4, r8, r7, lsl #16          // ....................................*...
        smulbb r6, r2, r11                 // ....................................*...
        usub16 r8, r5, r4                  // .....................................*..
        str r14, [r0, #20]                 // .....................................*..
        pkhbt r14, r6, r3, lsl #16         // ......................................*.
        str r8, [r0, #24]                  // ......................................*.
        usub16 r14, r1, r14                // .......................................*
        str r14, [r0], #32                 // .......................................*
