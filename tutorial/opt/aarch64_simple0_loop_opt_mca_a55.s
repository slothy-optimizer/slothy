...
mov count, #16
        ...
        sub count, count, #1
start:
        mul v3.8H, v23.8H, v0.H[0]              // ....*.............
        // gap                                  // ..................
        mul v19.8H, v27.8H, v0.H[0]             // .........*........
        // gap                                  // ..................
        sqrdmulh v21.8H, v23.8H, v0.H[1]        // .....*............
        // gap                                  // ..................
        sqrdmulh v29.8H, v27.8H, v0.H[1]        // ..........*.......
        // gap                                  // ..................
        ldr q27, [x0, #0]                       // *.................
        // gap                                  // ..................
        // gap                                  // ..................
        // gap                                  // ..................
        mls v3.8H, v21.8H, v1.H[0]              // ......*...........
        // gap                                  // ..................
        mls v19.8H, v29.8H, v1.H[0]             // ...........*......
        // gap                                  // ..................
        ldr q21, [x0, #32]                      // ..*...............
        // gap                                  // ..................
        // gap                                  // ..................
        // gap                                  // ..................
        add v29.8H, v27.8H, v3.8H               // ........*.........
        // gap                                  // ..................
        ldr q23, [x0, #80]                      // .e................
        // gap                                  // ..................
        // gap                                  // ..................
        // gap                                  // ..................
        add v5.8H, v21.8H, v19.8H               // .............*....
        // gap                                  // ..................
        str q29, [x0], #4*16                    // ..............*...
        // gap                                  // ..................
        sub v29.8H, v21.8H, v19.8H              // ............*.....
        // gap                                  // ..................
        str q5, [x0, #-32]                      // ................*.
        // gap                                  // ..................
        ...
        // Resource pressure by instruction:
        // [0.0]  [0.1]  [1]    [2]    [3.0]  [3.1]  [4]    [5.0]  [5.1]  [6]    [7]    [8]    Instructions:
        //  -      -      -      -      -     2.00    -      -      -      -      -      -     mul.8h	v3, v23, v0[0]
        //  -      -      -      -     2.00    -      -      -      -      -      -      -     mul.8h	v19, v27, v0[0]
        //  -      -      -      -      -     2.00    -      -      -      -      -      -     sqrdmulh.8h	v21, v23, v0[1]
        //  -      -      -      -     2.00    -      -      -      -      -      -      -     sqrdmulh.8h	v29, v27, v0[1]
        //  -      -      -      -      -      -      -      -      -     1.00    -      -     ldr	q27, [x0]
        //  -      -      -      -      -     2.00    -      -      -      -      -      -     mls.8h	v3, v21, v1[0]
        //  -      -      -      -     2.00    -      -      -      -      -      -      -     mls.8h	v19, v29, v1[0]
        //  -      -      -      -      -      -      -      -      -     1.00    -      -     ldr	q21, [x0, #32]
        //  -      -      -      -      -     2.00    -      -      -      -      -      -     add.8h	v29, v27, v3
        //  -      -      -      -      -      -      -      -      -     1.00    -      -     ldr	q23, [x0, #80]
        //  -      -      -      -     2.00    -      -      -      -      -      -      -     add.8h	v5, v21, v19
        //  -      -      -      -      -      -      -      -      -      -      -     1.00   str	q29, [x0], #64
        //  -      -      -      -      -     2.00    -      -      -      -      -      -     sub.8h	v29, v21, v19
        //  -      -      -      -      -      -      -      -      -      -      -     1.00   stur	q5, [x0, #-32]
        //  -      -      -      -     2.00    -      -      -      -      -      -      -     sub.8h	v11, v27, v3
        //  -      -      -      -      -      -      -      -      -      -      -     1.00   stur	q29, [x0, #-16]
        //  -      -      -      -      -      -      -      -      -     1.00    -      -     ldr	q27, [x0, #48]
        //  -      -      -      -      -      -      -      -      -      -      -     1.00   stur	q11, [x0, #-48]
        //
        ...
        //
        // [0,0]     DeeeE.    .    .    .    .    .    .    .    .    . .   mul.8h	v3, v23, v0[0]
        // [0,1]     .DeeeE    .    .    .    .    .    .    .    .    . .   mul.8h	v19, v27, v0[0]
        // [0,2]     . DeeeE   .    .    .    .    .    .    .    .    . .   sqrdmulh.8h	v21, v23, v0[1]
        // [0,3]     .  DeeeE  .    .    .    .    .    .    .    .    . .   sqrdmulh.8h	v29, v27, v0[1]
        // [0,4]     .   DeeE  .    .    .    .    .    .    .    .    . .   ldr	q27, [x0]
        // [0,5]     .    .DeeeE    .    .    .    .    .    .    .    . .   mls.8h	v3, v21, v1[0]
        // [0,6]     .    . DeeeE   .    .    .    .    .    .    .    . .   mls.8h	v19, v29, v1[0]
        // [0,7]     .    .  DeeE   .    .    .    .    .    .    .    . .   ldr	q21, [x0, #32]
        // [0,8]     .    .    DeE  .    .    .    .    .    .    .    . .   add.8h	v29, v27, v3
        // [0,9]     .    .    DeeE .    .    .    .    .    .    .    . .   ldr	q23, [x0, #80]
        // [0,10]    .    .    .DeE .    .    .    .    .    .    .    . .   add.8h	v5, v21, v19
        // [0,11]    .    .    . DE .    .    .    .    .    .    .    . .   str	q29, [x0], #64
        // [0,12]    .    .    .  DeE    .    .    .    .    .    .    . .   sub.8h	v29, v21, v19
        // [0,13]    .    .    .  DE.    .    .    .    .    .    .    . .   stur	q5, [x0, #-32]
        // [0,14]    .    .    .   DeE   .    .    .    .    .    .    . .   sub.8h	v11, v27, v3
        // [0,15]    .    .    .    DE   .    .    .    .    .    .    . .   stur	q29, [x0, #-16]
        // [0,16]    .    .    .    DeeE .    .    .    .    .    .    . .   ldr	q27, [x0, #48]
        // [0,17]    .    .    .    .DE  .    .    .    .    .    .    . .   stur	q11, [x0, #-48]
        // [1,0]     .    .    .    . DeeeE   .    .    .    .    .    . .   mul.8h	v3, v23, v0[0]
        // [1,1]     .    .    .    .  DeeeE  .    .    .    .    .    . .   mul.8h	v19, v27, v0[0]
        // [1,2]     .    .    .    .   DeeeE .    .    .    .    .    . .   sqrdmulh.8h	v21, v23, v0[1]
        // [1,3]     .    .    .    .    DeeeE.    .    .    .    .    . .   sqrdmulh.8h	v29, v27, v0[1]
        // [1,4]     .    .    .    .    .DeeE.    .    .    .    .    . .   ldr	q27, [x0]
        // [1,5]     .    .    .    .    .  DeeeE  .    .    .    .    . .   mls.8h	v3, v21, v1[0]
        // [1,6]     .    .    .    .    .   DeeeE .    .    .    .    . .   mls.8h	v19, v29, v1[0]
        // [1,7]     .    .    .    .    .    DeeE .    .    .    .    . .   ldr	q21, [x0, #32]
        // [1,8]     .    .    .    .    .    . DeE.    .    .    .    . .   add.8h	v29, v27, v3
        // [1,9]     .    .    .    .    .    . DeeE    .    .    .    . .   ldr	q23, [x0, #80]
        // [1,10]    .    .    .    .    .    .  DeE    .    .    .    . .   add.8h	v5, v21, v19
        // [1,11]    .    .    .    .    .    .   DE    .    .    .    . .   str	q29, [x0], #64
        // [1,12]    .    .    .    .    .    .    DeE  .    .    .    . .   sub.8h	v29, v21, v19
        // [1,13]    .    .    .    .    .    .    DE   .    .    .    . .   stur	q5, [x0, #-32]
        // [1,14]    .    .    .    .    .    .    .DeE .    .    .    . .   sub.8h	v11, v27, v3
        // [1,15]    .    .    .    .    .    .    . DE .    .    .    . .   stur	q29, [x0, #-16]
        // [1,16]    .    .    .    .    .    .    . DeeE    .    .    . .   ldr	q27, [x0, #48]
        // [1,17]    .    .    .    .    .    .    .  DE.    .    .    . .   stur	q11, [x0, #-48]
        // [2,0]     .    .    .    .    .    .    .   DeeeE .    .    . .   mul.8h	v3, v23, v0[0]
        // [2,1]     .    .    .    .    .    .    .    DeeeE.    .    . .   mul.8h	v19, v27, v0[0]
        // [2,2]     .    .    .    .    .    .    .    .DeeeE    .    . .   sqrdmulh.8h	v21, v23, v0[1]
        // [2,3]     .    .    .    .    .    .    .    . DeeeE   .    . .   sqrdmulh.8h	v29, v27, v0[1]
        // [2,4]     .    .    .    .    .    .    .    .  DeeE   .    . .   ldr	q27, [x0]
        // [2,5]     .    .    .    .    .    .    .    .    DeeeE.    . .   mls.8h	v3, v21, v1[0]
        // [2,6]     .    .    .    .    .    .    .    .    .DeeeE    . .   mls.8h	v19, v29, v1[0]
        // [2,7]     .    .    .    .    .    .    .    .    . DeeE    . .   ldr	q21, [x0, #32]
        // [2,8]     .    .    .    .    .    .    .    .    .   DeE   . .   add.8h	v29, v27, v3
        // [2,9]     .    .    .    .    .    .    .    .    .   DeeE  . .   ldr	q23, [x0, #80]
        // [2,10]    .    .    .    .    .    .    .    .    .    DeE  . .   add.8h	v5, v21, v19
        // [2,11]    .    .    .    .    .    .    .    .    .    .DE  . .   str	q29, [x0], #64
        // [2,12]    .    .    .    .    .    .    .    .    .    . DeE. .   sub.8h	v29, v21, v19
        // [2,13]    .    .    .    .    .    .    .    .    .    . DE . .   stur	q5, [x0, #-32]
        // [2,14]    .    .    .    .    .    .    .    .    .    .  DeE .   sub.8h	v11, v27, v3
        // [2,15]    .    .    .    .    .    .    .    .    .    .   DE .   stur	q29, [x0, #-16]
        // [2,16]    .    .    .    .    .    .    .    .    .    .   DeeE   ldr	q27, [x0, #48]
        // [2,17]    .    .    .    .    .    .    .    .    .    .    DE.   stur	q11, [x0, #-48]
        //
        //
        // Average Wait times (based on the timeline view):
        // [0]: Executions
        ...
        //
        //       [0]    [1]    [2]    [3]
        // 0.     3     0.0    0.0    0.0       mul.8h	v3, v23, v0[0]
        // 1.     3     0.0    0.0    0.0       mul.8h	v19, v27, v0[0]
        // 2.     3     0.0    0.0    0.0       sqrdmulh.8h	v21, v23, v0[1]
        // 3.     3     0.0    0.0    0.0       sqrdmulh.8h	v29, v27, v0[1]
        // 4.     3     0.0    0.0    0.0       ldr	q27, [x0]
        // 5.     3     0.0    0.0    0.0       mls.8h	v3, v21, v1[0]
        // 6.     3     0.0    0.0    0.0       mls.8h	v19, v29, v1[0]
        // 7.     3     0.0    0.0    0.0       ldr	q21, [x0, #32]
        // 8.     3     0.0    0.0    0.0       add.8h	v29, v27, v3
        // 9.     3     0.0    0.0    0.0       ldr	q23, [x0, #80]
        // 10.    3     0.0    0.0    0.0       add.8h	v5, v21, v19
        // 11.    3     0.0    0.0    0.0       str	q29, [x0], #64
        // 12.    3     0.0    0.0    0.0       sub.8h	v29, v21, v19
        // 13.    3     0.0    0.0    0.0       stur	q5, [x0, #-32]
        // 14.    3     0.0    0.0    0.0       sub.8h	v11, v27, v3
        // 15.    3     0.0    0.0    0.0       stur	q29, [x0, #-16]
        // 16.    3     0.0    0.0    0.0       ldr	q27, [x0, #48]
        // 17.    3     0.0    0.0    0.0       stur	q11, [x0, #-48]
        //        3     0.0    0.0    0.0       <total>
        //
        //
